...
Refer to the "Alphabet and Pronunciation Guide" (Elifbe) for detailed sound descriptions of each letter. The Elifbe provided is the *only* authoritative list of characters. Characters like 'â', 'é', 'ö', 'ü', or 'c' (for the /dʒ/ sound) are NOT part of this alphabet and MUST NOT be used.
...
- The letter 'I i':
  ...
  - For loanwords:
    - Those from European languages (e.g., English, Romanian, French) are typically written with 'I i'.
    - Loanwords of Arabic or Persian origin are an exception and generally follow native phonetic/orthographic patterns, thus more commonly using 'Í í' or 'Î î' based on vowel harmony and the surrounding phonetic environment, rather than 'I i'.
...
Naturalization:
This is the process of shifting academic speech sounds to authentic sounds. Crimean Tatar (Romania) strongly prefers naturalization (authentic speech) where applicable.
...
- The sound /tʃ/ (letter Ç ç) is rare in authentic Dobrujan Tatar; it is often pronounced and written as /ʃ/ (letter Ş ş). Thus, Ç ç and /tʃ/ can be considered academic or subject to naturalization to Ş ş. Use 'ş' by default.
- Word-final restrictions: The letters b, d, g, ğ, i, ó, u, ú, v generally cannot occur at the end of a word (exceptions include 'ald' and 'dad'). See the Alphabet and Pronunciation Guide for each letter's behavior.
- Word-initial restrictions: The letter ñ cannot appear at the beginning of a word. For example, "ping-pong" is translated as "pink-ponk".
- The letter Ğ ğ consistently represents the /dʒ/ sound (like 'j' in English 'gem'). Standard Crimean Tatar or Turkish 'c' for /dʒ/ MUST be converted to 'ğ'.

Letter Groups "aá" and "áa":
These are writing conventions for vowel harmony in inflection, as detailed in the Alphabet and Pronunciation Guide.
- "aá": The word is read according to the first vowel 'a', but inflected according to the second vowel 'á'. Example: kaár (care) is read like kar (snow), but in ablative: kaárden (from care) vs. kardan (from snow).
...
export const CRIMEAN_TATAR_RO_SCT_DT_SUMMARY_INFO = `
...
export const CRIMEAN_TATAR_RO_EXAMPLES = `
...
--- Start of SCT -> Crimean Tatar (RO) Transformation Examples and Rules ---

The following examples and rules illustrate common transformations when adapting Standard Crimean Tatar (SCT) or similar Turkic forms to Crimean Tatar (Romania) [Crimean Tatar (RO)]. These are based on observed patterns and should guide translation.

**1. Comitative Case (Expressing "with"):**
...
- **i -> í in pronouns before suffixes:**
  - biz -> bíz- (e.g., bízge "to us", bíz men "with us")
  - kim -> kím- (e.g., kímge "to whom", kím men "with whom")
- **u -> î in specific noun roots (lexical):**
  - SCT: armut (pear) -> Crimean Tatar (RO): armît (Example: Armîtnîñ tadî "the pear's taste")
  - SCT: köpür (bridge) -> Crimean Tatar (RO): kópír
  - SCT: yumurta (egg) -> Crimean Tatar (RO) (potential): ğîmîrta (Y->Ğ, u->î) - *This is a strong hypothesis.*
- **General Vowel Transformations (SCT -> Crimean Tatar (RO)):**
...
- SCT f -> Crimean Tatar (RO) p
- SCT v -> Crimean Tatar (RO) w (or b)
- SCT ç -> Crimean Tatar (RO) ş
...
- SCT: Üç balıq suvda yüze edi. (Three fish were swimming in the water.)
  - Crimean Tatar (RO): Úş balîk suwda yúze edí.
...
- SCT: Mektepniñ çetinde büyük bir terek bar. (There is a big tree next to the school.)
  - Crimean Tatar (RO): Mektepníñ şetínde búyúk bír terek bar.
  - (Mektepniñ: SCT i->RO í; çetinde: SCT ç->RO ş, SCT i->RO í; büyük: SCT ü->RO ú; bir->bír)

- SCT: Seninle kim kelecek? (With whom will you come?)
  - Crimean Tatar (RO): Sen men kím keleğek?
...
- SCT: Bu işni kiminle yapacaqsıñ? (With whom will you do this work?)
  - Crimean Tatar (RO): Bo íşní kím men yapağaksîñ?
  - (Bu->Bo; işni -> íşní (SCT i->RO í); kiminle -> kím men; yapacaqsıñ -> yapağaksîñ (SCT q->RO k, SCT ı->RO î))

- SCT: Olar babalarıman bazarga kettiler. (They went to the market with their father.)
  - Crimean Tatar (RO): Olar babalarî men bazarga kettíler.
...
KÎRÎM TATARĞA ÁLEM-Í NEBATAT
Herbarium Scythicum ad scientiam conformatus

        <dt>Abelmoschus esculentus</dt>
        <dd>•bamiye</dd>
        <dd>•kelínparmagî</dd>
        ...
        <dt>Abies cephalonica</dt>
        <dd>•Rum-narusî</dd>
        <dd>•Rum-ládiní</dd>
        <dd>•Rum-şîrşîsî</dd>

        <dt>Abies concolor</dt>
        <dd>•gúmúş-narus</dd>
        <dd>•gúmúş-ládin</dd>
        <dd>•gúmúş-şîrşî</dd>
        ...
        <dt>Abies lasiocarpa</dt>
        <dd>•dagaşasî-narusî</dd>
        <dd>•dagaşasî-ládiní</dd>
        <dd>•dagaşasî-şîrşîsî</dd>

        <dt>Abies magnifica</dt>
        <dd>•kîrmîzî-narus</dd>
        <dd>•kîrmîzî-ládin</dd>
        <dd>•kîrmîzî-şîrşî</dd>

        <dt>Abies nordmanniana</dt>
        <dd>•Kawkaz-narusî</dd>
        <dd>•Kawkaz-ládiní</dd>
        <dd>•Kawkaz-şîrşîsî</dd>
        ...
        <dt>Abies sibirica</dt>
        <dd>•Sebír-narusî</dd>
        <dd>•Sebír-ládiní</dd>
        <dd>•Sebír-şîrşîsî</dd>

        <dt>Abutilon theophrasti</dt>
        <dd>•tereksîrgasî</dd>

        <dt>Acacia</dt>
        <dd>•akasiya</dd>

        <dt>Acanthopanax senticosus</dt>
        <dd>•tayga</dd>

        <dt>Acanthus longifolius</dt>
        <dd>•kenger</dd>

        <dt>Acer campestre</dt>
        <dd>•kîr-úreñgesí</dd>
        <dd>•kîr-akşateregí</dd>

        <dt>Acer monspessulanum</dt>
        <dd>•Frengístan-úreñgesí</dd>
        <dd>•Frengístan-akşateregí</dd>

        <dt>Acer negundo</dt>
        <dd>•Amerika-akşateregí</dd>

        <dt>Acer platanoides</dt>
        <dd>•akşaterek</dd>

        <dt>Acer pseudoplatanus</dt>
        <dd>•yalanğî-şarîn</dd>
        <dd>•isfender</dd>

        <dt>Acer saccharinum</dt>
        <dd>•gúmúş-akşaterek</dd>

        <dt>Acer saccharum</dt>
        <dd>•şeker-akşateregí</dd>

        <dt>Acer tataricum</dt>
        <dd>•akşa-kayîñ</dd>
        <dd>•úreñge</dd>

        <dt>Aceras anthropophorum</dt>
        <dd>•insan-salebí</dd>

        <dt>Acetosa pratensis</dt>
        <dd>•ekşí-atkulak</dd>

        <dt>Achillea millefolium</dt>
        <dd>•ğiwanperşemí</dd>
        <dd>•biñbíryaprak</dd>

        <dt>Achillea ptarmica</dt>
        <dd>•hoğaakayhapşîrdî</dd>

        <dt>Achusa officinalis</dt>
        <dd>•sîyîrtílí</dd>

        <dt>Aconitum anthora</dt>
        <dd>•sarî-buwmaotî</dd>
        <dd>•sarî-kaşkîrbuwgan</dd>

        <dt>Aconitum firmum</dt>
        <dd>•kattî-buwmaotî</dd>
        <dd>•kattî-kaşkîrbuwgan</dd>

        <dt>Aconitum napellus</dt>
        <dd>•mawî-buwmaotî</dd>
        <dd>•mawî-kaşkîrbuwgan</dd>

        <dt>Aconitum orientale</dt>
        <dd>•Kawkaz-buwmaotî</dd>
        <dd>•Kawkaz-kaşkîrbuwgan</dd>

        <dt>Aconitum sp.</dt>
        <dd>•buwmaotî</dd>
        <dd>•kaşkîrbuwgan</dd>

        <dt>Aconitum toxicum</dt>
        <dd>•kók-buwmaotî</dd>
        <dd>•kók-kaşkîrbuwgan</dd>

        <dt>Aconitum variegatum</dt>
        <dd>•alaşa-buwmaotî</dd>
        <dd>•alaşa-kaşkîrbuwgan</dd>

        <dt>Aconitum vulparia</dt>
        <dd>•túlkí-buwmaotî</dd>
        <dd>•túlkí-kaşkîrbuwganî</dd>

        <dt>Acorus calamus</dt>
        <dd>•egír</dd>

        <dt>Actaea spicata</dt>
        <dd>•ğîlan-şelegí</dd>

        <dt>Actinidia chinensis</dt>
        <dd>•kiwiy</dd>

        <dt>Adenophora liliifolia</dt>
        <dd>•kelín-şañşeşegí</dd>

        <dt>Adiantum capillus-veneris</dt>
        <dd>•baldîrîkara</dd>

        <dt>Adonanthe vernalis</dt>
        <dd>•baárlík-awğîotî</dd>
        <dd>•baárlík-keklíkotî</dd>

        <dt>Adonis aestivalis</dt>
        <dd>•ğazlîk-awğîotî</dd>
        <dd>•ğazlîk-keklíkotî</dd>

        <dt>Adonis annua</dt>
        <dd>•kúzlúk-awğîotî</dd>
        <dd>•kúzlúk-keklíkotî</dd>

        <dt>Adonis autumnalis</dt>
        <dd>•kúzlúk-awğîotî</dd>
        <dd>•kúzlúk-keklíkotî</dd>

        <dt>Adonis flammea</dt>
        <dd>•kîzîl-awğîotî</dd>
        <dd>•kîzîl-keklíkotî</dd>

        <dt>Adonis vernalis</dt>
        <dd>•baárlík-awğîotî</dd>
        <dd>•baárlík-keklíkotî</dd>

        <dt>Adoxa moschatellina</dt>
        <dd>•tabîrgaotî</dd>
        <dd>•ğuparotî</dd>

        <dt>Aegopodium podagraria</dt>
        <dd>•eşkíayagî</dd>

        <dt>Aesculus carnea</dt>
        <dd>•kîrmîzî-at-kestanesí</dd>
        <dd>•kîrmîzî-şabalît</dd>

        <dt>Aesculus hippocastanum</dt>
        <dd>•at-kestanesí</dd>
        <dd>•şabalît</dd>

        <dt>Aethusa cynapium</dt>
        <dd>•it-ğeparesí</dd>
        <dd>•it-megdúnezí</dd>

        <dt>Agaricus arvensis</dt>
        <dd>•katîr-peşmegí</dd>

        <dt>Agaricus bisporus</dt>
        <dd>•biyaz-şapkelí-peşmek</dd>

        <dt>Agaricus bitorquis</dt>
        <dd>•kaldîrîm-peşmegí</dd>

        <dt>Agaricus campestris</dt>
        <dd>•kîr-peşmegí</dd>

        <dt>Agaricus silvaticus Schaeff</dt>
        <dd>•gúlpembe-taw-peşmegí</dd>

        <dt>Agaricus xanthodermus</dt>
        <dd>•şawdar-peşmek</dd>

        <dt>Agrimonia eupatoria</dt>
        <dd>•koşkar-kînabî</dd>
        <dd>•koşkar-kenevirí</dd>
        <dd>•koşkar-kendírí</dd>
        <dd>•koy-tegenegí</dd>

        <dt>Agriopyrum caninum</dt>
        <dd>•it-ayrîgî</dd>

        <dt>Agriopyrum repens</dt>
        <dd>•ayrîk</dd>

        <dt>Agrostemma githago</dt>
        <dd>•karamîk</dd>

        <dt>Agrostis alba</dt>
        <dd>•ak-tawuzotî</dd>

        <dt>Agrostis canina</dt>
        <dd>•it-tawuzotî</dd>

        <dt>Agrostis stolonifera</dt>
        <dd>•ak-tawuzotî</dd>

        <dt>Ailanthus altissima</dt>
        <dd>•kokarterek</dd>

        <dt>Ailanthus glandulose</dt>
        <dd>•kokarterek</dd>

        <dt>Ajuga chamaepitys</dt>
        <dd>•bodîret</dd>

        <dt>Ajuga genevensis</dt>
        <dd>•tuzlîbalgamotî</dd>

        <dt>Ajuga reptans</dt>
        <dd>•dak-tuzlîbalgamotî</dd>

        <dt>Alchemilla vulgaris</dt>
        <dd>•aslanpenşesí</dd>
        <dd>•kelínşemsiyesí</dd>

        <dt>Alisma plantago-aquatica</dt>
        <dd>•bakatílí</dd>
        <dd>•suw-bakaotî</dd>
        <dd>•suw-ğaraotî</dd>

        <dt>Alliaria petiolata</dt>
        <dd>•sarîmsakotî</dd>

        <dt>Allium ascalonicum</dt>
        <dd>•eşalot-soganî</dd>
        ...
        <dt>Allium cepa viviparium</dt>
        <dd>•arpağîk</dd>

        <dt>Allium fistulosum</dt>
        <dd>•kanara-soganî</dd>

        <dt>Allium porrum ampeloprasum</dt>
        <dd>•sogankewer</dd>
        <dd>•kalba</dd>
        <dd>•pîrasa</dd>

        <dt>Allium rotundum</dt>
        <dd>•şekíldem</dd>

        <dt>Allium sativum</dt>
        <dd>•sarîmsak</dd>

        <dt>Allium schoenoprasum</dt>
        <dd>•şayîr-sarîmsagî</dd>
        <dd>•ğuwa</dd>

        <dt>Allium ursinum</dt>
        <dd>•ayuw-sarîmsagî</dd>
        <dd>•pagîr</dd>

        <dt>Allium vineale</dt>
        <dd>•kamgar</dd>
        ...
        <dt>Alopecurus pratensis</dt>
        <dd>•şayîr-túlkíkuyrugî</dd>

        <dt>Alpinia cardamomum</dt>
        <dd>•kakule</dd>

        <dt>Althaea officinalis</dt>
        <dd>•hatmiy</dd>
        ...
        <dt>Alyssum minimum</dt>
        <dd>•aksakal</dd>

        <dt>Amanita muscaria</dt>
        <dd>•şîbîn-peşmegí</dd>

        <dt>Amaranthus angustifolius</dt>
        <dd>•tîzban</dd>

        <dt>Amaranthus caudatus</dt>
        <dd>•solmazşeşek</dd>

        <dt>Amaranthus retroflexus</dt>
        <dd>•tílkíkuyrugî</dd>
        <dd>•kamkul</dd>
        ...
        <dt>Amomum cardamon</dt>
        <dd>•kakule</dd>

        <dt>Amomum grana paradisi</dt>
        <dd>•etrefil</dd>

        <dt>Amomum melegueta</dt>
        <dd>•etrefil</dd>

        <dt>Ampelopsis brevipendunculata</dt>
        <dd>•meriyemana-asmasî</dd>

        <dt>Amygdalus formis</dt>
        <dd>•taw-armutî</dd>
        <dd>•taw-kertpesí</dd>

        <dt>Amygdalus communis</dt>
        <dd>•badem</dd>

        <dt>Amygdalus persica</dt>
        <dd>•şeftalí</dd>

        <dt>Anacardium orientale</dt>
        <dd>•malakka-ğewezí</dd>

        <dt>Anacylus pyrethrum</dt>
        <dd>•nezleotî</dd>

        <dt>Anagallis arvensis</dt>
        <dd>•súlúkotî</dd>

        <dt>Ananas sativus</dt>
        <dd>•ananas</dd>

        <dt>Anastatica hierochuntica</dt>
        <dd>•anakolî</dd>

        <dt>Anchusa officinalis</dt>
        <dd>•sîyîrtílí</dd>

        <dt>Andropogon citratum</dt>
        <dd>•limonotî</dd>
        <dd>•takray</dd>

        <dt>Anemone hepatica</dt>
        <dd>•karağíger-ğelşeşegí</dd>
        <dd>•karağígerotî</dd>

        <dt>Anemone ranunculoides</dt>
        <dd>•sarî-ğelşeşegí</dd>

        <dt>Anemone silvestris</dt>
        <dd>•taw-ğelşeşegí</dd>

        <dt>Anemone sp.</dt>
        <dd>•ğelşeşegí</dd>

        <dt>Anethum graveolens</dt>
        <dd>•daragurt</dd>
        <dd>•şebet</dd>

        <dt>Angelica archangelica</dt>
        <dd>•melekotî</dd>
        <dd>•taral</dd>

        <dt>Angelica officinalis</dt>
        <dd>•melekotî</dd>
        <dd>•taral</dd>

        <dt>Anisum vulgare</dt>
        <dd>•enison</dd>
        <dd>•anason</dd>
        <dd>•nanehan</dd>

        <dt>Antennaria dioica</dt>
        <dd>•mîşîkayagî</dd>

        <dt>Anthemis arvensis</dt>
        <dd>•şayîr-akkírpígí</dd>
        <dd>•şayîr-mollabaşî</dd>
        <dd>•şayîr-şobanyastîgî</dd>
        <dd>•şayîr-papatiyasî</dd>

        <dt>Anthemis cotula</dt>
        <dd>•it-akkírpígí</dd>
        <dd>•it-mollabaşî</dd>
        <dd>•it-şobanyastîgî</dd>
        <dd>•it-papatiyasî</dd>

        <dt>Anthoxanthum odoratum</dt>
        <dd>•kokîlîot</dd>

        <dt>Anthriscus cerefolium</dt>
        <dd>•múslí-ğepare</dd>
        <dd>•múslí-megdúnez</dd>

        <dt>Anthriscus silvestris</dt>
        <dd>•tana-ğeparesí</dd>
        <dd>•tana-megdúnezí</dd>

        <dt>Anthyllis vulneraria</dt>
        <dd>•şoban-úşgúlí</dd>
        <dd>•şoban-yonğasî</dd>

        <dt>Antirrhinum majus</dt>
        <dd>•aslanawuzî</dd>

        <dt>Apium graveolens</dt>
        <dd>•kerewez</dd>
        <dd>•kerpez</dd>
        <dd>•baldîrtamîr</dd>

        <dt>Apocynum cannabinum</dt>
        <dd>•kendír</dd>

        <dt>Aquilegia vulgaris</dt>
        <dd>•kartşagaysîrgasî</dd>

        <dt>Arabis alpina</dt>
        <dd>•gúmúşsepet</dd>
        <dd>•kazotî</dd>

        <dt>Arabis hirsuta</dt>
        <dd>•gúmúşsepet</dd>
        <dd>•kazotî</dd>

        <dt>Arachis hypogaea</dt>
        <dd>•ğer-fîstîgî</dd>
        <dd>•arakît</dd>

        <dt>Araucaria angustifolia</dt>
        <dd>•arawukariya-şamî</dd>

        <dt>Arctium lappa</dt>
        <dd>•tulapakayotî</dd>

        <dt>Arctostaphylos uva ursi</dt>
        <dd>•motmotî</dd>
        <dd>•ayuw-yúzúmí</dd>

        <dt>Arenaria serpylligfolia</dt>
        <dd>•kumlukotî</dd>

        <dt>Aristolochia clematitis</dt>
        <dd>•loksaotî</dd>
        <dd>•ğalpakkulak</dd>

        <dt>Armeniaca vulgaris</dt>
        <dd>•kayise</dd>
        <dd>•zerdale</dd>

        <dt>Armoracia lapathifolia</dt>
        <dd>•bayîr-turubî</dd>
        <dd>•aşşî-turup</dd>
        <dd>•kîtîktamîrî</dd>

        <dt>Armoracia rusticana</dt>
        <dd>•bayîr-turubî</dd>
        <dd>•aşşî-turup</dd>
        <dd>•kîtîktamîrî</dd>
        ...
        <dt>Arrhenatherum elatius</dt>
        <dd>•şayîr-alefí</dd>
        <dd>•şayîr-yulavî</dd>
        <dd>•şayîr-súlesí</dd>

        <dt>Artemisia abrotanum</dt>
        <dd>•kara-ğawşan</dd>
        <dd>•ğîz</dd>
        <dd>•kara-mideotî</dd>

        <dt>Artemisia absinthium</dt>
        <dd>•ğawşan</dd>
        <dd>•mideotî</dd>

        <dt>Artemisia annua</dt>
        <dd>•sîtma-ğawşanî</dd>
        <dd>•sîtma-mideotî</dd>
        <dd>•sîtmaotî</dd>

        <dt>Artemisia austriaca</dt>
        <dd>•ak-ğawşan</dd>
        <dd>•ak-mideotî</dd>

        <dt>Artemisia dracunculus</dt>
        <dd>•tarkun</dd>

        <dt>Artemisia pontica</dt>
        <dd>•ğaga-ğawşanî</dd>
        <dd>•ğaga-mideotî</dd>

        <dt>Artemisia scoparia</dt>
        <dd>•sîpîrga-ğawşanî</dd>
        <dd>•sîpîrga-mideotî</dd>

        <dt>Artocarpus incisa</dt>
        <dd>•ótmekteregí</dd>

        <dt>Arum maculatum</dt>
        <dd>•ğîlanyastîgî</dd>

        <dt>Arundo donax</dt>
        <dd>•deñíz-sazî</dd>

        <dt>Asarum europaeum</dt>
        <dd>•kîrşîmağîotî</dd>
        <dd>•şayîr-zenğefilí</dd>

        <dt>Asarum officinalis</dt>
        <dd>•kîrşîmağîotî</dd>
        <dd>•şayîr-zenğefilí</dd>

        <dt>Asclepias vincetoxicum</dt>
        <dd>•karîlgaşkuyrugî</dd>
        <dd>•zerimarotî</dd>

        <dt>Asparagus officinalis</dt>
        <dd>•kuşkonmaz</dd>

        <dt>Asparagus silvestris</dt>
        <dd>•kulanşar</dd>

        <dt>Aspidum filix-mas</dt>
        <dd>•tóşekotî</dd>
        <dd>•egreltí</dd>
        <dd>•kîja</dd>

        <dt>Asplenium adianthum nigrum</dt>
        <dd>•kara-tóşek</dd>

        <dt>Asplenium ruta-muraria</dt>
        <dd>•kalaw-tóşegí</dd>

        <dt>Asplenium trichomanes</dt>
        <dd>•ufak-tóşek</dd>

        <dt>Aster laexigatus</dt>
        <dd>•ayuwkulagî</dd>
        <dd>•saray-patî</dd>

        <dt>Astragalus glycyphyllos</dt>
        <dd>•kitre</dd>

        <dt>Atriplex hortensis</dt>
        <dd>•kara-atkulak</dd>
        <dd>•kara-pazî</dd>

        <dt>Atriplex nitens</dt>
        <dd>•kara-atkulak</dd>
        <dd>•kara-pazî</dd>

        <dt>Atropa belladona</dt>
        <dd>•dúlberbiyke</dd>
        ...
        <dt>Bellis perennis</dt>
        <dd>•koşkarkózí</dd>

        <dt>Berberis vulgaris</dt>
        <dd>•tegenek-yúzúmí</dd>
        <dd>•zírínş</dd>
        ...
        <dt>Beta vulgaris conditiva</dt>
        <dd>•kîrmîzî-pazî</dd>
        <dd>•kîrmîzî-şógender</dd>
        <dd>•kîrmîzî-şugundur</dd>
        <dd>•kîrmîzî-panğar</dd>

        <dt>Beta vulgaris saccharifera</dt>
        <dd>•şeker-pazîsî</dd>
        <dd>•şeker-şógenderí</dd>
        <dd>•şeker-şugundurî</dd>
        <dd>•şeker-panğarî</dd>

        <dt>Betonica officinalis</dt>
        <dd>•kestere</dd>
        ...
        <dt>Betula pendula</dt>
        <dd>•akterek</dd>
        <dd>•tozterek</dd>

        <dt>Bistorta major</dt>
        <dd>•ğîlanótmegí</dd>

        <dt>Bolbochoenus maritimus</dt>
        <dd>•koga</dd>
        <dd>•şegen</dd>

        <dt>Boletus aereus</dt>
        <dd>•ekşí-peşmek</dd>

        <dt>Boletus bovinus</dt>
        <dd>•tana-peşmegí</dd>

        <dt>Boletus edulis</dt>
        <dd>•taş-mantar</dd>

        <dt>Boletus luteus</dt>
        <dd>•sarî-mantar</dd>

        <dt>Borago officinalis</dt>
        <dd>•kozîtílí</dd>
        <dd>•kodan</dd>
        <dd>•nese</dd>

        <dt>Boswellia sacra</dt>
        <dd>•kúnlúk</dd>

        <dt>Botrychium lunaria</dt>
        <dd>•kolan-tóşegí</dd>

        <dt>Bovista plumbea</dt>
        <dd>•kók-kómbelek</dd>

        <dt>Brassica alba</dt>
        <dd>•biyaz-hardal</dd>

        <dt>Brassica napus esculenta</dt>
        <dd>•şalgam</dd>

        <dt>Brassica napus napobrassica</dt>
        <dd>•şalgam</dd>

        <dt>Brassica napus oleifera</dt>
        <dd>•may-şalgamî</dd>

        <dt>Brassica nigra</dt>
        <dd>•kara-hardal</dd>

        <dt>Brassica oleracea</dt>
        <dd>•kapîsta</dd>
        <dd>•kelem</dd>

        <dt>Brassica oleracea botrytis</dt>
        <dd>•karnîbahar</dd>
        <dd>•gúl-kelem</dd>

        <dt>Brassica oleracea capitata</dt>
        <dd>•baş-kapîsta</dd>
        <dd>•biyaz-kapîsta</dd>
        <dd>•baş-kelem</dd>
        <dd>•biyaz-kelem</dd>

        <dt>Brassica oleracea gemmifera</dt>
        <dd>•Brúksel-kapîstasî</dd>
        <dd>•gúl-kapîstasî</dd>
        <dd>•fransîz-kelemí</dd>

        <dt>Brassica oleracea gongyloides</dt>
        <dd>•alabaş</dd>

        <dt>Brassica oleracea italica</dt>
        <dd>•brókóliy</dd>

        <dt>Brassica oleracea rubara</dt>
        <dd>•kîrmîzî-kapîsta</dd>
        <dd>•kîrmîzî-kelem</dd>

        <dt>Brassica oleracea sabauda</dt>
        <dd>•buruşuk-kapîsta</dd>
        <dd>•buruşuk-kelem</dd>

        <dt>Brassica rapa oleifera</dt>
        <dd>•may-şalgamî</dd>

        <dt>Brassica sinapis</dt>
        <dd>•hardal</dd>

        <dt>Briza media</dt>
        <dd>•karîlgaş-arpasî</dd>

        <dt>Bromus ramosus</dt>
        <dd>•şayîr-şawdarî</dd>

        <dt>Bromus secalinus</dt>
        <dd>•ğat</dd>

        <dt>Bryonia alba</dt>
        <dd>•it-kabagî</dd>

        <dt>Butomus umbellatus</dt>
        <dd>•kasîrşeşegí</dd>

        <dt>Buxus sempervirens</dt>
        <dd>•şîmşat</dd>
        <dd>•şímşír</dd>

        <dt>Cacao Quianensis</dt>
        <dd>•kakao</dd>

        <dt>Cacao sativa</dt>
        <dd>•kakao</dd>

        <dt>Cactus grandiflorus</dt>
        <dd>•kaktus</dd>
        <dd>•kaynanatílí</dd>

        <dt>Calamagrostis epigeios</dt>
        <dd>•botşîk</dd>

        <dt>Calamus rotang</dt>
        <dd>•tayak-kamîşî</dd>

        <dt>Calendula officinalis</dt>
        <dd>•sefaşeşegí</dd>

        <dt>Callistephus chinensis</dt>
        <dd>•Kîtay-patî</dd>

        <dt>Calluna vulgaris</dt>
        <dd>•funda</dd>

        <dt>Caltha palustris</dt>
        <dd>•bataklîk-nergisí</dd>

        <dt>Calystegia sepium</dt>
        <dd>•çit-sarmaşîgî</dd>
        <dd>•şít-sarmaşîgî</dd>

        <dt>Camelia japonica</dt>
        <dd>•kameliya</dd>

        <dt>Campanula barbata</dt>
        <dd>•sakallî-şañşeşegí</dd>

        <dt>Campanula bononiensis</dt>
        <dd>•solgan-şañşeşegí</dd>

        <dt>Campanula cervicaria</dt>
        <dd>•eríşken-şañşeşegí</dd>

        <dt>Campanula latifolia</dt>
        <dd>•ğalpakyaprak-şañşeşegí</dd>

        <dt>Campanula rotundifolia</dt>
        <dd>•mawî-şañşeşegí</dd>

        <dt>Campanula sibirica</dt>
        <dd>•Sebír-şañşeşegí</dd>

        <dt>Campanula trachelium</dt>
        <dd>•şadîrşeşegí</dd>
        <dd>•şalkanak-şañşeşegí</dd>

        <dt>Canna indica</dt>
        <dd>•tespihşeşegí</dd>

        <dt>Cannabis indica</dt>
        <dd>•kenevir</dd>
        <dd>•kînap</dd>

        <dt>Cantharellus cibarius</dt>
        <dd>•sarî-peşmek</dd>

        <dt>Capparis spinosa</dt>
        <dd>•kebre</dd>

        <dt>Capsella bursa-pastoris</dt>
        <dd>•şobantorbasî</dd>

        <dt>Capsicum annuum</dt>
        <dd>•turşuluk-búber</dd>
        <dd>•búber</dd>
        <dd>•dolmalîk-búber</dd>
        <dd>•kîrmîzî-búber</dd>

        <dt>Capsicum annuum acuminatum</dt>
        <dd>•aşşî-búber</dd>

        <dt>Capsicum frutescens</dt>
        <dd>•ateş-búberí</dd>
        <dd>•çiliy-búberí</dd>

        <dt>Cardamine palustris</dt>
        <dd>•bataklîk-teresí</dd>

        <dt>Cardamine pratensis</dt>
        <dd>•şayîr-teresí</dd>

        <dt>Cardaria draba</dt>
        <dd>•kîraw-teresí</dd>

        <dt>Cardum gairdneri</dt>
        <dd>•yam-kartop</dd>
        <dd>•yam-bereñge</dd>

        <dt>Carduus acanthoides</dt>
        <dd>•ayuwtîrnagî</dd>

        <dt>Carduus crispus</dt>
        <dd>•şól-kankalî</dd>

        <dt>Carduus kerneri</dt>
        <dd>•kírpítîrnagî</dd>

        <dt>Carduus marianus</dt>
        <dd>•dewe-tegenegí</dd>

        <dt>Carduus nutans</dt>
        <dd>•kankal</dd>

        <dt>Carex carryophyllea</dt>
        <dd>•dórtyaprak-ayakotî</dd>

        <dt>Carex pilosa</dt>
        <dd>•ayakotî</dd>

        <dt>Carex riparia</dt>
        <dd>•karîlgaş-ayakotî</dd>

        <dt>Carex silvatica</dt>
        <dd>•ayakotî</dd>

        <dt>Carica papaya</dt>
        <dd>•papaya</dd>

        <dt>Carlina acaulis</dt>
        <dd>•gúmúş-tegenek</dd>

        <dt>Carpinus betulus</dt>
        <dd>•ulas</dd>
        <dd>•huliya</dd>

        <dt>Carpinus orientalis</dt>
        <dd>•alşak-ulas</dd>
        <dd>•alşak-huliya</dd>

        <dt>Carthamus tinctorius</dt>
        <dd>•yalanğî-zeferan</dd>
        <dd>•aspîr</dd>

        <dt>Carum bulbocastanum</dt>
        <dd>•manda-fîndîgî</dd>
        <dd>•mandalîk</dd>
        ...
        <dt>Caryophyllus aromaticus</dt>
        <dd>•kalampîr</dd>

        <dt>Cassia angustifolia</dt>
        <dd>•sinameke</dd>

        <dt>Castanea sativa</dt>
        <dd>•kestane</dd>

        <dt>Castanea vesca</dt>
        <dd>•kestane</dd>
        ...
        <dt>Celosia cristata</dt>
        <dd>•korazkekeşí</dd>

        <dt>Celtis australis</dt>
        <dd>•şetlenbek</dd>

        <dt>Centaurea calcitrapa</dt>
        <dd>•nardin</dd>

        <dt>Centaurea cyanus</dt>
        <dd>•zengere</dd>
        <dd>•peygamberşeşegí</dd>

        <dt>Centaurea solstitialis</dt>
        <dd>•sarî-tegenek</dd>

        <dt>Centaurium umbellatum</dt>
        <dd>•ğúrgeş</dd>
        <dd>•kantarun</dd>

        <dt>Cephaelis ipecacuanha</dt>
        <dd>•altîntamîr</dd>
        <dd>•kusmatamîrî</dd>
        <dd>•ipeka</dd>

        <dt>Cerastium alpinum</dt>
        <dd>•dak-ğumurankulagî</dd>

        <dt>Cerastium arvense</dt>
        <dd>•ğîlga-ğumurankulagî</dd>

        <dt>Cerastium fontanum</dt>
        <dd>•ğumurankulagî</dd>

        <dt>Cerastium perfoliatum</dt>
        <dd>•ğumurankulagî</dd>

        <dt>Cerasus avium</dt>
        <dd>•kiraz</dd>

        <dt>Ceratonia siliqua</dt>
        <dd>•eşkímúyúzí</dd>

        <dt>Cereu grandiflorus</dt>
        <dd>•kaktus</dd>
        <dd>•kaynanatílí</dd>

        <dt>Chaerophyllum aromaticum</dt>
        <dd>•ğer-ğewezí</dd>

        <dt>Chaerophyllum bulbosum</dt>
        <dd>•ğer-kestanesí</dd>

        <dt>Chaiturus marrubiastrum</dt>
        <dd>•sîrkaotî</dd>

        <dt>Chamomilla recutita</dt>
        <dd>•akkírpík</dd>
        <dd>•mollabaşî</dd>
        <dd>•şobanyastîgî</dd>
        <dd>•papatiya</dd>

        <dt>Cheiranthus cheiri</dt>
        <dd>•sarî-şebay</dd>

        <dt>Chelidonium majus</dt>
        <dd>•karîlgaşotî</dd>

        <dt>Chenopodium album</dt>
        <dd>•ak-kazayagî</dd>

        <dt>Chenopodium ambrosioides</dt>
        <dd>•múslí-kazayagî</dd>

        <dt>Chenopodium bonus-frenricus</dt>
        <dd>•semíz-kazayagî</dd>

        <dt>Chenopodium botrys</dt>
        <dd>•múslí-pazî</dd>

        <dt>Chenopodium hybridum</dt>
        <dd>•kazayagî</dd>

        <dt>Chenopodium murale</dt>
        <dd>•kalawotî</dd>

        <dt>Chicorium intybus</dt>
        <dd>•mawî-endibe</dd>

        <dt>Chondrilla juncea</dt>
        <dd>•ğelínotî</dd>

        <dt>Chrysanthemum alpinum</dt>
        <dd>•dak-ateşotî</dd>
        <dd>•dak-gúmúştúymesí</dd>

        <dt>Chrysanthemum balsamita</dt>
        <dd>•belseme</dd>

        <dt>Chrysanthemum cinerariaefolium</dt>
        <dd>•boz-búrşeotî</dd>

        <dt>Chrysanthemum indicum</dt>
        <dd>•krizantema</dd>

        <dt>Chrysanthemum leucanthemum</dt>
        <dd>•ógízkózí</dd>
        <dd>•pat</dd>

        <dt>Chrysanthemum parthenium</dt>
        <dd>•ateşotî</dd>
        <dd>•gúmúştúyme</dd>

        <dt>Chrysanthemum vulgare</dt>
        <dd>•şîlawşanotî</dd>

        <dt>Cicer arietinum</dt>
        <dd>•nogît</dd>

        <dt>Cichorium endivia</dt>
        <dd>•hindiba</dd>
        ...
        <dt>Cinchona cordifolia</dt>
        <dd>•şifalî-kînakîna</dd>

        <dt>Cinchona pubescens</dt>
        <dd>•şifalî-kînakîna</dd>

        <dt>Cinchona succiruba</dt>
        <dd>•şifalî-kînakîna</dd>

        <dt>Cineraria hybrida</dt>
        <dd>•şineriye</dd>

        <dt>Cinnamomum camphora</dt>
        <dd>•kafur</dd>

        <dt>Cinnamomum verum</dt>
        <dd>•tarşîn</dd>

        <dt>Cinnamomum zeylanicum</dt>
        <dd>•tarşîn</dd>

        <dt>Cirsium arvense</dt>
        <dd>•şól-tegenegí</dd>

        <dt>Cirsium canum</dt>
        <dd>•ak-tegenek</dd>

        <dt>Cirsium furiens</dt>
        <dd>•delí-tegenek</dd>

        <dt>Cirsium oleraceum</dt>
        <dd>•uyuz-tegenegí</dd>

        <dt>Cirsium vulgare</dt>
        <dd>•tegenek</dd>

        <dt>Citrullus vulgaris</dt>
        <dd>•karbîz</dd>

        <dt>Citrus aurantifolia</dt>
        <dd>•tatlî-limon</dd>

        <dt>Citrus aurantium dulcis</dt>
        <dd>•eflisun</dd>
        <dd>•memiş</dd>
        <dd>•portakal</dd>

        <dt>Citrus bigaradia</dt>
        <dd>•narînş</dd>
        <dd>•turunş</dd>
        ...
        <dt>Citrus nobilis</dt>
        <dd>•mandarina</dd>
        <dd>•narînga</dd>

        <dt>Citrus paradisi</dt>
        <dd>•grepfurt</dd>

        <dt>Clavaria coralloides</dt>
        <dd>•tokmakşîk</dd>

        <dt>Clavaria flava</dt>
        <dd>•eşkí-peşmegí</dd>

        <dt>Claviceps purpurea</dt>
        <dd>•kaşkîrtíşí</dd>
        <dd>•şawdarmahmuzî</dd>

        <dt>Clematis recta</dt>
        <dd>•pîkare-asmasî</dd>

        <dt>Clematis vitalba</dt>
        <dd>•ak-asma</dd>

        <dt>Cnicus benedictus</dt>
        <dd>•şewketotî</dd>
        <dd>•múbarek-tegenek</dd>

        <dt>Coccinia indica</dt>
        <dd>•kundur</dd>

        <dt>Cochlearia armoracia</dt>
        <dd>•bayîr-turubî</dd>
        <dd>•aşşî-turup</dd>
        <dd>•kîtîktamîrî</dd>

        <dt>Cochlearia officinalis</dt>
        <dd>•kaşîkotî</dd>

        <dt>Cocos nucifera</dt>
        <dd>•hindístan-ğewezí</dd>
        <dd>•narğîl</dd>

        <dt>Coffea arabica</dt>
        <dd>•kawe</dd>

        <dt>Cola Acuminata</dt>
        <dd>•kola-ğewezí</dd>
        <dd>•kola</dd>
        ...
        <dd>•sîzanak-sinamekesí</dd>

        <dt>Conium maculatum</dt>
        <dd>•aguwotî</dd>
        <dd>•baldîran</dd>

        <dt>Consolida ajacis</dt>
        <dd>•sorgîş</dd>

        <dt>Consolida regalis</dt>
        <dd>•hezaren</dd>
        <dd>•hezeran</dd>

        <dt>Convallaria majalis</dt>
        <dd>•dúrdaneşeşegí</dd>
        <dd>•inğíşeşegí</dd>

        <dt>Convolvulus arvensis</dt>
        <dd>•bak-sarmaşîgî</dd>
        <dd>•kozî-sarmaşîgî</dd>

        <dt>Convolvulus sepium</dt>
        <dd>•çit-sarmaşîgî</dd>
        <dd>•şít-sarmaşîgî</dd>

        <dt>Conyza canadensis</dt>
        <dd>•şifaotî</dd>

        <dt>Copaifera officinalis</dt>
        <dd>•ğañîdúniya-pelesenkteregí</dd>

        <dt>Coriandrum sativum</dt>
        <dd>•kuzbare</dd>
        <dd>•keşníş</dd>
        ...
        <dt>Cornus sanguinea</dt>
        <dd>•kermeşík</dd>
        <dd>•zogal</dd>

        <dt>Coronilla varia</dt>
        <dd>•taş-yonğasî</dd>

        <dt>Corydalis bulbosa</dt>
        <dd>•boztorgayotî</dd>

        <dt>Corylus avellana</dt>
        <dd>•fîndîk</dd>

        <dt>Cotoneaster integerrima</dt>
        <dd>•taş-aywasî</dd>
        <dd>•dak-ğumuşkasî</dd>
        <dd>•dak-muşmulasî</dd>

        <dt>Crataegus monogyna</dt>
        <dd>•alîş</dd>
        <dd>•ğemíşan</dd>
        <dd>•kaálp-gúlí</dd>

        <dt>Crataegus oxyacantha</dt>
        <dd>•beşiynelí-alîş</dd>
        <dd>•beşinelí-ğemíşan</dd>
        <dd>•beşiynelí-kaálp-gúlí</dd>

        <dt>Crepis foetida</dt>
        <dd>•dúmbúrdemeotî</dd>

        <dt>Crepis rhocadifolia</dt>
        <dd>•dúmbúrdemeotî</dd>

        <dt>Crispis biennis</dt>
        <dd>•şewer</dd>

        <dt>Crocus heuffelianus</dt>
        <dd>•şiydem</dd>

        <dt>Crocus moesiacus</dt>
        <dd>•sarî-şiydem</dd>

        <dt>Crocus sativus</dt>
        <dd>•zafran</dd>
        <dd>•zeferan</dd>

        <dt>Croton tiglium</dt>
        <dd>•krotan</dd>
        ...
        <dt>Cucumis sativus</dt>
        <dd>•salatalîk</dd>
        <dd>•ğerpenek</dd>
        <dd>•gúlbeser</dd>

        <dt>Cucurbita pepo maxima</dt>
        <dd>•kabak</dd>
        <dd>•bal-kabagî</dd>
        <dd>•bostan</dd>

        <dt>Cucurbita pepo oblonga</dt>
        <dd>•kebeke</dd>

        <dt>Cuminum cyminum</dt>
        <dd>•ağem-kemenegí</dd>
        <dd>•ağem-ziresí</dd>

        <dt>Cupressus sempervirens</dt>
        <dd>•añdîz</dd>
        <dd>•selviy</dd>
        ...
        <dt>Cyclamen europaeum</dt>
        <dd>•koyankulagî</dd>

        <dt>Cydonia vulgaria</dt>
        <dd>•aywa</dd>
        <dd>•kúrt</dd>

        <dt>Cymbopogon citratus</dt>
        <dd>•limonotî</dd>
        <dd>•takray</dd>

        <dt>Cynanchum vincetoxicum</dt>
        <dd>•karîlgaşkuyrugî</dd>
        <dd>•zerimarotî</dd>

        <dt>Cynara scolymus</dt>
        <dd>•enginar</dd>

        <dt>Cynodon dactylon</dt>
        <dd>•ittíşí</dd>

        <dt>Cynoglossum officinalis</dt>
        <dd>•ittílí</dd>

        <dt>Cynosurus cristatus</dt>
        <dd>•ittaragî</dd>

        <dt>Cyperus flavescens</dt>
        <dd>•şemsiyeşeşegí</dd>

        <dt>Cypripedium calceolus</dt>
        <dd>•kelínpápíşí</dd>

        <dt>Cytisus hirsutus</dt>
        <dd>•dak-katîrtîrnagî</dd>

        <dt>Cytisus laburnum</dt>
        <dd>•sarî-katîrtîrnagî</dd>
        <dd>•sarî-salkîm</dd>

        <dt>Cytisus nigricans</dt>
        <dd>•kara-katîrtîrnagî</dd>

        <dt>Cytisus sagittalis</dt>
        <dd>•katîrtîrnagî</dd>

        <dt>Cytisus scoparius</dt>
        <dd>•sîpîrga-katîrtîrnagî</dd>

        <dt>Dactylis glomerata</dt>
        <dd>•domîz-ayrîgî</dd>

        <dt>Dahlia cultorum</dt>
        <dd>•daliya</dd>
        <dd>•yîldîzşeşegí</dd>

        <dt>Daphne mezereum</dt>
        <dd>•aşşî-defne</dd>
        <dd>•tulabdalotî</dd>

        <dt>Datura stramonium</dt>
        <dd>•tatula</dd>

        <dt>Daucus carota</dt>
        <dd>•ğîr-keşír</dd>

        <dt>Daucus carota sativa</dt>
        <dd>•keşír</dd>
        <dd>•ğertamîrî</dd>
        <dd>•ğertazîlî</dd>

        <dt>Daucus silvestris</dt>
        <dd>•ğîr-keşír</dd>

        <dt>Delphinium ajacis</dt>
        <dd>•sorgîş</dd>

        <dt>Delphinium consolida</dt>
        <dd>•hezaren</dd>
        <dd>•hezeran</dd>

        <dt>Dentaria bulbifera</dt>
        <dd>•başlî-tíşotî</dd>

        <dt>Dentaria glandulosa</dt>
        <dd>•bezlí-tíşotî</dd>

        <dt>Desmodium gyrans</dt>
        <dd>•telşeşegí</dd>

        <dt>Dianthus barbatus</dt>
        <dd>•bakşa-karanfilí</dd>
        <dd>•bakşa-kalampîrî</dd>

        <dt>Dianthus carthusianorum</dt>
        <dd>•şayîr-karanfilí</dd>
        <dd>•şayîr-kalampîrî</dd>

        <dt>Dianthus caryophyllus</dt>
        <dd>•karanfil</dd>
        <dd>•kalampîr</dd>

        <dt>Dianthus chinensis</dt>
        <dd>•Kîtay-karanfilí</dd>
        <dd>•Kîtay-kalampîrî</dd>

        <dt>Dianthus compactus</dt>
        <dd>•dak-karanfilí</dd>
        <dd>•dak-kalampîrî</dd>

        <dt>Dianthus spiculifolius</dt>
        <dd>•iyneyapraklî-karanfil</dd>
        <dd>•iyneyapraklî-kalampîr</dd>

        <dt>Dictamnus albus</dt>
        <dd>•maralotî</dd>

        <dt>Dictamnus fraxinella</dt>
        <dd>•maralotî</dd>

        <dt>Digitalis ambigua</dt>
        <dd>•oymakotî</dd>
        <dd>•yúksúkotî</dd>

        <dt>Digitalis lanata</dt>
        <dd>•ğúnlí-oymakotî</dd>
        <dd>•ğúnlí-yúksúkotî</dd>

        <dt>Digitalis purpurea</dt>
        <dd>•kîrmîzî-oymakotî</dd>
        <dd>•kîrmîzî-yúksúkotî</dd>

        <dt>Dipsacus pilosus</dt>
        <dd>•tarakotî</dd>
        <dd>•şobantaragî</dd>

        <dt>Discorea balatas</dt>
        <dd>•yam-kartop</dd>
        <dd>•yam-bereñge</dd>

        <dt>Dracocephalum fruticulosum</dt>
        <dd>•şímeldek</dd>

        <dt>Drosera rotundifolia</dt>
        <dd>•kúneş-gúlí</dd>

        <dt>Dryopteris filix-mas</dt>
        <dd>•tóşekotî</dd>
        <dd>•egreltí</dd>
        <dd>•kîja</dd>

        <dt>Dyospiros kaki</dt>
        <dd>•abanoz</dd>
        <dd>•Japon-kurmasî</dd>

        <dt>Ecballium elaterium</dt>
        <dd>•pîrtatkan</dd>
        <dd>•aşşî-kawun</dd>
        <dd>•eşek-ğerpenegí</dd>
        <dd>•aşşî-salatalîk</dd>
        <dd>•aşşî-gúlbeser</dd>

        <dt>Echinops commutatus</dt>
        <dd>•kírpí-mandalagî</dd>

        <dt>Echinops sphaerocephalus</dt>
        <dd>•algar</dd>
        <dd>•kírpíkalpagî</dd>

        <dt>Echium altissimum</dt>
        <dd>•sîyîrkuyrugî</dd>

        <dt>Echium rubrum</dt>
        <dd>•kîrmîzî-sîyîrkuyrugî</dd>

        <dt>Elaegnus angustifolia</dt>
        <dd>•igde</dd>

        <dt>Elettaria cardamomum</dt>
        <dd>•kakule</dd>

        <dt>Eleutherococcus senticosus</dt>
        <dd>•tayga</dd>

        <dt>Empetrum nigrum</dt>
        <dd>•karga-yúzúmí</dd>

        <dt>Ephedra distachya</dt>
        <dd>•deñíz-yúzúmí</dd>

        <dt>Epilobium angustifolim</dt>
        <dd>•ğakmaotî</dd>

        <dt>Equisetum arvense</dt>
        <dd>•katîrkuyrugî</dd>

        <dt>Equisetum hyemale</dt>
        <dd>•kîşlîk-katîrkuyrugî</dd>

        <dt>Equisetum telmateja</dt>
        <dd>•eşkíkuyrugî</dd>

        <dt>Erigeron acris</dt>
        <dd>•mawî-búrşeotî</dd>

        <dt>Erigeron canadensis</dt>
        <dd>•şifaotî</dd>

        <dt>Erodium cicutarium</dt>
        <dd>•kaytbabay</dd>

        <dt>Eryngium campestre</dt>
        <dd>•bak-tegenegí</dd>

        <dt>Eryngium planum</dt>
        <dd>•mor-tegenek</dd>
        <dd>•şagîr-mandalak</dd>

        <dt>Erysimum officinalis</dt>
        <dd>•dak-mezeliyesí</dd>

        <dt>Erythrea pulchella</dt>
        <dd>•gúzel-ğúrgeş</dd>
        <dd>•gúzel-kantarun</dd>

        <dt>Erythroxylon coca</dt>
        <dd>•koka</dd>

        <dt>Eucalyptus sp.</dt>
        <dd>•ewukalipt</dd>

        <dt>Eugenia aromatica</dt>
        <dd>•kalampîr</dd>

        <dt>Eupatorium cannabinum</dt>
        <dd>•ğîr-kendír</dd>
        <dd>•ğîr-kenevir</dd>
        <dd>•ğîr-kînap</dd>
        <dd>•şetene</dd>

        <dt>Euphorbia cyparissias</dt>
        <dd>•sútlegen</dd>

        <dt>Euphorbia helioscopia</dt>
        <dd>•sewdek</dd>

        <dt>Euphrasia officinalis</dt>
        <dd>•şetenekózdermanî</dd>

        <dt>Euphrasia stricta</dt>
        <dd>•şetenekózdermanî</dd>

        <dt>Evonymus europaea</dt>
        <dd>•ğumukşî</dd>
        <dd>•popazkalpagî</dd>
        <dd>•papazkalpagî</dd>

        <dt>Evonymus verrucosa</dt>
        <dd>•şumurt</dd>

        <dt>Fagopyrum esculentum</dt>
        <dd>•kara-biyday</dd>
        <dd>•kara-maşak</dd>

        <dt>Fagus sylvatica</dt>
        <dd>•kayîñ</dd>
        <dd>•korakayîñ</dd>

        <dt>Fagus sylvatica atrorubens</dt>
        <dd>•kîzîl-kayîñ</dd>

        <dt>Ferula assa-foetida</dt>
        <dd>•şaytantersí</dd>
        <dd>•şaytanbogî</dd>
        <dd>•sasîksakîz</dd>
        <dd>•angúze</dd>
        ...
        <dt>Ficus elastica</dt>
        <dd>•yalanğî-ínğír</dd>
        <dd>•bardaşîk</dd>

        <dt>Ficus sycomorus</dt>
        <dd>•ballîtarî</dd>
        <dd>•azamat-ínğír</dd>

        <dt>Filago germanica</dt>
        <dd>•ğúnotî</dd>

        <dt>Filipendula ulmaria</dt>
        <dd>•tekesakalî</dd>

        <dt>Filipendula vulgaris</dt>
        <dd>•kandilşeşegí</dd>

        <dt>Foeniculum vulgare</dt>
        <dd>•raziyane</dd>
        <dd>•rezene</dd>

        <dt>Fomes igniarius</dt>
        <dd>•yas</dd>
        <dd>•as</dd>
        <dd>•kaw</dd>
        <dd>•meşke</dd>
        ...
        <dt>Fomes pinicola</dt>
        <dd>•narus-yasî</dd>
        <dd>•şam-kawî</dd>

        <dt>Fragaria elatior</dt>
        <dd>•şelek</dd>

        <dt>Fragaria vesca</dt>
        <dd>•taw-ğetkeneşelegí</dd>

        <dt>Fraxinus alba</dt>
        <dd>•ak-kókrík</dd>
        <dd>•ak-korîş</dd>

        <dt>Fraxinus excelsior</dt>
        <dd>•kókrík</dd>
        <dd>•korîş</dd>
        ...
        <dt>Fritillaria meleagris</dt>
        <dd>•taj-lálesí</dd>

        <dt>Fuchsia</dt>
        <dd>•kúpeşeşegí</dd>

        <dt>Fucus vesiculosus</dt>
        <dd>•ketenşík</dd>
        <dd>•deñíz-yasî</dd>

        <dt>Fumaria officinalis</dt>
        <dd>•şah-tere</dd>

        <dt>Gagea pratensis</dt>
        <dd>•şayîr-súmbúlí</dd>

        <dt>Galanthus nivalis</dt>
        <dd>•aktaş</dd>
        <dd>•karşañî</dd>
        <dd>•karşeşegí</dd>
        <dd>•karteşken</dd>
        ...
        <dt>Galega officinalis</dt>
        <dd>•eşkí-sedefí</dd>

        <dt>Galeobdolon luteum</dt>
        <dd>•sarî-ballîbaba</dd>
        <dd>•sarî-şímgek</dd>

        <dt>Galeopsis ladanum</dt>
        <dd>•mîşîkbaşî</dd>

        <dt>Galeopsis speciosa</dt>
        <dd>•renklí-mîşîkbaşî</dd>

        <dt>Galeopsis tetrahit</dt>
        <dd>•tegeneklí-mîşîkbaşî</dd>

        <dt>Galium aparine</dt>
        <dd>•katîkotî</dd>

        <dt>Galium rotundifolium</dt>
        <dd>•ğalpak-katîkotî</dd>

        <dt>Galium schultesii</dt>
        <dd>•bayîltkan-katîkotî</dd>

        <dt>Galium verum</dt>
        <dd>•sarî-katîkotî</dd>

        <dt>Ganoderma applanatum</dt>
        <dd>•kayîñ-yasî</dd>
        <dd>•korakayîñ-kawî</dd>

        <dt>Gardenia jasminoides</dt>
        <dd>•yaseminkardeniyesí</dd>

        <dt>Gardenia thunbergia</dt>
        <dd>•ak-kardeniye</dd>

        <dt>Genista tinctoria</dt>
        <dd>•boyağî-katîrtîrnagî</dd>

        <dt>Gentiana asclepiadea</dt>
        <dd>•mawî-dakşañî</dd>

        <dt>Gentiana lutea</dt>
        <dd>•sarî-dakşañî</dd>

        <dt>Gentiana sp.</dt>
        <dd>•dakşañî</dd>

        <dt>Geranium dissectum</dt>
        <dd>•alşeşeklí-legelekgágáasî</dd>

        <dt>Geranium macrorrhizum</dt>
        <dd>•legelekgágáasî</dd>

        <dt>Geranium phaeum</dt>
        <dd>•morşeşeklí-legelekgágáasî</dd>

        <dt>Geranium pratense</dt>
        <dd>•şayîr-legelekgágáasî</dd>

        <dt>Geranium robertianum</dt>
        <dd>•sasîk-legelekgágáasî</dd>
        <dd>•şeken</dd>

        <dt>Geum rivale</dt>
        <dd>•ğîlga-karanfiltamîrî</dd>
        <dd>•ğîlga-kalampîrtamîrî</dd>

        <dt>Geum urbanum</dt>
        <dd>•karanfiltamîrî</dd>
        <dd>•kalampîrtamîrî</dd>

        <dt>Ginkgo biloba</dt>
        <dd>•akîlteregí</dd>

        <dt>Gladiolus gandavensis</dt>
        <dd>•kuzgîkîlîşî</dd>

        <dt>Glaucium corniculatum</dt>
        <dd>•tamgalî-afiyon</dd>
        <dd>•tamgalî-haşhaş</dd>
        <dd>•tamgalî-kelínşekşeşegí</dd>

        <dt>Glaux maritima</dt>
        <dd>•ğîlansútí</dd>

        <dt>Glechoma hederacea</dt>
        <dd>•ğer-sarmaşîgî</dd>

        <dt>Globaria gigantea</dt>
        <dd>•attomalagî</dd>

        <dt>Glyceria fluitans</dt>
        <dd>•suw-yúzúmí</dd>

        <dt>Glycine hispida</dt>
        <dd>•meş-paklasî</dd>
        <dd>•soya-paklasî</dd>

        <dt>Glycine maxima</dt>
        <dd>•meş-paklasî</dd>
        <dd>•soya-paklasî</dd>

        <dt>Glycyrrhiza glabra</dt>
        <dd>•miyan</dd>
        <dd>•miyantamîrî</dd>
        <dd>•tatlîtamîr</dd>

        <dt>Gnaphalium dioicum</dt>
        <dd>•altînotî</dd>

        <dt>Gnaphalium silvaticum</dt>
        <dd>•taw-altînotî</dd>

        <dt>Gratiola officinalis</dt>
        <dd>•kudayberdíotî</dd>

        <dt>Guaiacum officinalis</dt>
        <dd>•guwayak</dd>
        <dd>•peygamberteregí</dd>

        <dt>Guaiacum sanctum</dt>
        <dd>•guwayak</dd>
        <dd>•peygamberteregí</dd>

        <dt>Gypsophila paniculata</dt>
        <dd>•baáryîldîzî</dd>
        <dd>•maşaklî-sabînotî</dd>

        <dt>Haematoxylon campechianum</dt>
        <dd>•bakam</dd>

        <dt>Hamamelis mollis</dt>
        <dd>•hamamelis</dd>

        <dt>Hedera helix</dt>
        <dd>•sarmaşîk</dd>
        <dd>•kalaw-sarmaşîgî</dd>

        <dt>Hedysarum obscurum</dt>
        <dd>•dak-korazbaşî</dd>
        <dd>•dak-korîngasî</dd>

        <dt>Heleocharis palustris</dt>
        <dd>•kîlgana</dd>

        <dt>Helianthemum alpestre</dt>
        <dd>•dak-taşgúlí</dd>

        <dt>Helianthemum nummularium</dt>
        <dd>•sarî-taşgúlí</dd>

        <dt>Helianthemum rupifragum</dt>
        <dd>•dak-taşgúlí</dd>

        <dt>Helianthus annuus</dt>
        <dd>•kúntabak</dd>

        <dt>Helianthus tuberosus</dt>
        <dd>•ğer-elmasî</dd>

        <dt>Helichrysum arenarium</dt>
        <dd>•ólmezşeşek</dd>

        <dt>Helichrysum bracteatum</dt>
        <dd>•herdemtaze</dd>
        <dd>•tobanotî</dd>

        <dt>Helichrysum orientale</dt>
        <dd>•sarî-ólmezşeşek</dd>
        <dd>•sarî-herdemtaze</dd>
        <dd>•sarî-tobanotî</dd>

        <dt>Helleborus niger</dt>
        <dd>•boz-múyúzotî</dd>

        <dt>Helleborus purpurescens</dt>
        <dd>•kîzîl-múyúzotî</dd>

        <dt>Hemerocallis flava</dt>
        <dd>•kúneşgúzelí</dd>
        <dd>•sarî-zambak</dd>

        <dt>Hepatica nobilis</dt>
        <dd>•karağíger-ğelşeşegí</dd>
        <dd>•karağígerotî</dd>

        <dt>Heracleum palmatum</dt>
        <dd>•ğalpak-koyanotî</dd>
        <dd>•ğalpak-tawlayotî</dd>

        <dt>Heracleum sphondylium</dt>
        <dd>•koyanotî</dd>
        <dd>•tawlayotî</dd>

        <dt>Herniaria glabra</dt>
        <dd>•atğargan</dd>
        <dd>•bozkîrotî</dd>

        <dt>Hevea brasiliensis</dt>
        <dd>•kawuçuk</dd>

        <dt>Hibiscus cannabinus</dt>
        <dd>•kenevir</dd>
        <dd>•kînap</dd>

        <dt>Hibiscus esculentus</dt>
        <dd>•bamiye</dd>
        <dd>•kelínparmagî</dd>

        <dt>Hibiscus trionum</dt>
        <dd>•karga-lálesí</dd>

        <dt>Hieracium pilosella</dt>
        <dd>•îşankulagî</dd>

        <dt>Hippophae rhamnoides</dt>
        <dd>•ğíğílík</dd>

        <dt>Holoschoenus vulgaris</dt>
        <dd>•mîğa</dd>
        <dd>•şakan</dd>

        <dt>Holosteum umbellatum</dt>
        <dd>•turupşa</dd>

        <dt>Hordeum distichon</dt>
        <dd>•ekísîralî-arpa</dd>

        <dt>Hordeum vulgare</dt>
        <dd>•arpa</dd>
        <dd>•kópsîralî-arpa</dd>

        <dt>Humulus lupulus</dt>
        <dd>•şerbetşíotî</dd>
        <dd>•mayaotî</dd>
        <dd>•kîlmak</dd>

        <dt>Hyacinthus orientalis</dt>
        <dd>•súmbúl</dd>

        <dt>Hydrangea opuloides</dt>
        <dd>•hortensiya</dd>
        <dd>•ortanğa</dd>

        <dt>Hydrocaris morsus ranae</dt>
        <dd>•bakatíşlemesí</dd>

        <dt>Hydrocotyle vulgaris</dt>
        <dd>•suwtaşî</dd>

        <dt>Hyoscyamus niger</dt>
        <dd>•banotî</dd>
        <dd>•bengotî</dd>

        <dt>Hypericum acutum</dt>
        <dd>•ótken-kîlîşotî</dd>

        <dt>Hypericum maculatum</dt>
        <dd>•meneklí-biñbírteşíkotî</dd>
        <dd>•meneklí-kîlîşotî</dd>

        <dt>Hypericum perforatum</dt>
        <dd>•biñbírteşíkotî</dd>
        <dd>•kîlîşotî</dd>

        <dt>Hypochoeris radicata</dt>
        <dd>•mîşîkkulagî</dd>

        <dt>Hyssopus officinalis</dt>
        <dd>•zufa</dd>

        <dt>Iberis semperflorens</dt>
        <dd>•şeşeklí-túyúmotî</dd>

        <dt>Iberis umbellata</dt>
        <dd>•túyúmotî</dd>

        <dt>Ilex paraguayensis</dt>
        <dd>•mate</dd>
        <dd>•peruw-şayî</dd>

        <dt>Illicium anisatum</dt>
        <dd>•yîldîz-enisonî</dd>
        <dd>•yîldîz-anasonî</dd>
        <dd>•badiyan</dd>
        <dd>•yîldîz-nanehanî</dd>

        <dt>Illicium verum</dt>
        <dd>•yîldîz-enisonî</dd>
        <dd>•yîldîz-anasonî</dd>
        <dd>•badiyan</dd>
        <dd>•yîldîz-nanehanî</dd>

        <dt>Impatiens balsamina</dt>
        <dd>•kînaşeşegí</dd>

        <dt>Impatiens nolitangere</dt>
        <dd>•tiymemaga</dd>

        <dt>Inula conyza</dt>
        <dd>•búrşe-añdîzotî</dd>

        <dt>Inula helenium</dt>
        <dd>•añdîzotî</dd>

        <dt>Ipomaea purpurea</dt>
        <dd>•borazanşeşegí</dd>

        <dt>Ipomoea batatas</dt>
        <dd>•tatlî-kartop</dd>
        <dd>•tatlî-bereñge</dd>

        <dt>Iris germanica</dt>
        <dd>•súsen</dd>
        <dd>•nawruz</dd>

        <dt>Iris pseudacorus</dt>
        <dd>•fuliya</dd>
        ...
        <dt>Isatis tinctoria</dt>
        <dd>•keriyaşewetí</dd>
        <dd>•şewetotî</dd>

        <dt>Jasminum officinalis</dt>
        <dd>•yasemin</dd>
        ...
        <dt>Juncus buffonius</dt>
        <dd>•tanaotî</dd>

        <dt>Juncus effusus</dt>
        <dd>•kasîrotî</dd>

        <dt>Juniperus communis</dt>
        <dd>•ardîş</dd>
        <dd>•arğa</dd>
        <dd>•arşa</dd>

        <dt>Juniperus intermedia</dt>
        <dd>•maylas</dd>

        <dt>Juniperus nana</dt>
        <dd>•alşak-ardîş</dd>
        <dd>•alşak-arğa</dd>
        <dd>•alşak-arşa</dd>

        <dt>Juniperus sabina</dt>
        <dd>•zerlí-ardîş</dd>
        <dd>•kara-arğa</dd>
        <dd>•sasîk-arşa</dd>

        <dt>Kochia scoparia</dt>
        <dd>•sîpîrgaşeşegí</dd>

        <dt>Laburnum anagyroides</dt>
        <dd>•sarî-katîrtîrnagî</dd>
        <dd>•sarî-salkîm</dd>

        <dt>Lactarius deliciosus</dt>
        <dd>•sútlí-peşmek</dd>

        <dt>Lactarius piperatus</dt>
        <dd>•aşşî-peşmek</dd>

        <dt>Lactarius volemus</dt>
        <dd>•sútlí-peşmek</dd>

        <dt>Lactuca muralis</dt>
        <dd>•kalaw-salatasî</dd>

        <dt>Lactuca sagittata</dt>
        <dd>•mañka-salata</dd>

        <dt>Lactuca sativa</dt>
        <dd>•salata</dd>

        <dt>Lactuca serriola</dt>
        <dd>•ğîr-salata</dd>

        <dt>Lagenaria gourda</dt>
        <dd>•suw-kabagî</dd>
        ...
        <dt>Lamium galeobdolon</dt>
        <dd>•sarî-ballîbaba</dd>
        <dd>•sarî-şímgek</dd>

        <dt>Lamium purpureum</dt>
        <dd>•kîrmîzî-ballîbaba</dd>
        <dd>•kîrmîzî-şímgek</dd>

        <dt>Lapsana communis</dt>
        <dd>•emzíkotî</dd>
        ...
        <dt>Lathyrus niger</dt>
        <dd>•kara-burşak</dd>

        <dt>Lathyrus odoratus</dt>
        <dd>•îtîrşahîm</dd>

        <dt>Lathyrus tuberosus</dt>
        <dd>•tokmaklî-burşak</dd>

        <dt>Laurus nobilis</dt>
        <dd>•defne</dd>

        <dt>Lavandula angustifolia</dt>
        <dd>•lávanta</dd>

        <dt>Lavandula officinalis</dt>
        <dd>•lávanta</dd>
        ...
        <dt>Leonurus cardiaca</dt>
        <dd>•aslankuyrugî</dd>
        <dd>•kazayagî</dd>

        <dt>Lepidium campestre</dt>
        <dd>•ekşí-tere</dd>

        <dt>Lepidium sativum</dt>
        <dd>•tere</dd>

        <dt>Levisticum officinalis</dt>
        <dd>•selamotî</dd>

        <dt>Ligusticum mutellina</dt>
        <dd>•ayuw-daragurtî</dd>
        <dd>•ayuw-şebetí</dd>

        <dt>Ligustrum vulgare</dt>
        <dd>•itbawurî</dd>

        <dt>Lilium candidum</dt>
        <dd>•zambak</dd>

        <dt>Lilium martagon</dt>
        <dd>•taw-zambagî</dd>
        <dd>•kîrmîzî-zambak</dd>

        <dt>Lilium tigrinum</dt>
        <dd>•ğolparîs-zambagî</dd>

        <dt>Linaria vulgaris</dt>
        <dd>•nawrezotî</dd>

        <dt>Linum austriacum</dt>
        <dd>•şayîr-ketení</dd>

        <dt>Linum catharticum</dt>
        <dd>•zegerek</dd>

        <dt>Linum flavum</dt>
        <dd>•sarî-keten</dd>

        <dt>Linum usitatissimum</dt>
        <dd>•keten</dd>

        <dt>Lithospermum arvense</dt>
        <dd>•taşkesken</dd>

        <dt>Lobelia inflata</dt>
        <dd>•lobeliya</dd>

        <dt>Lolium perenne</dt>
        <dd>•uzunómírlí-şím</dd>

        <dt>Lolium temulentum</dt>
        <dd>•karamîk</dd>
        <dd>•delí-koray</dd>
        <dd>•biyday-korayî</dd>
        ...
        <dt>Loranthus Europaeus</dt>
        <dd>•palamut-bagamburşî</dd>
        <dd>•palamut-gúwelegí</dd>
        <dd>•meşe-ókseotî</dd>

        <dt>Lotus corniculatus</dt>
        <dd>•maralmúyúzí</dd>

        <dt>Lotus uligi-nosus</dt>
        <dd>•ğalpak-maralmúyúzí</dd>

        <dt>Lupinus albus</dt>
        <dd>•biyaz-aşşî-pakla</dd>

        <dt>Lupinus luteus</dt>
        <dd>•sarî-aşşî-pakla</dd>

        <dt>Lychnis flos cuculi</dt>
        <dd>•kukuklámbasî</dd>

        <dt>Lycium vulgare</dt>
        <dd>•şawak</dd>

        <dt>Lycoperdon bovista</dt>
        <dd>•ógíz-kómbelegí</dd>

        <dt>Lycoperdon communis</dt>
        <dd>•kíyík-kómbelegí</dd>

        <dt>Lycopersicum esculentum</dt>
        <dd>•domatis</dd>
        <dd>•turşuluk-domatis</dd>

        <dt>Lycopodium clavatum</dt>
        <dd>•kaşkîrayagî</dd>

        <dt>Lysimachia nummularia</dt>
        <dd>•kargaotî</dd>

        <dt>Lysimachia punctata</dt>
        <dd>•ğatalakotî</dd>
        <dd>•meneklí-kargaotî</dd>

        <dt>Lythrum salicaria</dt>
        <dd>•kulma</dd>

        <dt>Magnolia</dt>
        <dd>•magnoliya</dd>

        <dt>Majorana hortensis</dt>
        <dd>•merğankeş</dd>
        <dd>•merzene</dd>

        <dt>Malus domestica</dt>
        <dd>•elma</dd>
        <dd>•alma</dd>

        <dt>Malus sylvestris</dt>
        <dd>•taw-elmasí</dd>

        <dt>Malva silvestris</dt>
        <dd>•ibanaygúmeşí</dd>
        <dd>•tawkalaşî</dd>

        <dt>Mangifera indica</dt>
        <dd>•mango</dd>

        <dt>Marrubium vulgare</dt>
        <dd>•bozotî</dd>
        <dd>•itotî</dd>

        <dt>Matricaria chamomilla</dt>
        <dd>•akkírpík</dd>
        <dd>•mollabaşî</dd>
        <dd>•şobanyastîgî</dd>
        <dd>•papatiya</dd>

        <dt>Matthiola annua</dt>
        <dd>•kîzîl-şebay</dd>

        <dt>Matthiola incana</dt>
        <dd>•kîzîl-şebay</dd>

        <dt>Medicago sativa</dt>
        <dd>•ğumruşka</dd>

        <dt>Melilotus albus</dt>
        <dd>•ak-koğayonğa</dd>

        <dt>Melilotus coerulea</dt>
        <dd>•mawî-koğayonğa</dd>

        <dt>Melilotus officinalis</dt>
        <dd>•sarî-ğalpakyonğa</dd>

        <dt>Melissa offincinalis</dt>
        <dd>•balaotî</dd>
        <dd>•balotî</dd>

        <dt>Mentha aquatica</dt>
        <dd>•suw-nanesí</dd>
        <dd>•suw-bótnegí</dd>

        <dt>Mentha crispa</dt>
        <dd>•buruşuk-nane</dd>
        <dd>•buruşuk-bótnek</dd>

        <dt>Mentha piperita</dt>
        <dd>•nane</dd>
        <dd>•bótnek</dd>

        <dt>Mentha pulegium</dt>
        <dd>•ğarpîz</dd>

        <dt>Mentha silvestris</dt>
        <dd>•taw-nanesí</dd>
        <dd>•taw-bótnegí</dd>
        <dd>•filiskin</dd>

        <dt>Menyanthes trifoliata</dt>
        <dd>•aşşî-úşgúl</dd>
        <dd>•aşşî-yonğa</dd>

        <dt>Mercurialis annua</dt>
        <dd>•ğer-feslegení</dd>
        <dd>•sultanotî</dd>

        <dt>Mercurialis perennis</dt>
        <dd>•kaşkîr-sultanotî</dd>

        <dt>Merulius lacrymans</dt>
        <dd>•kalaw-peşmegí</dd>

        <dt>Mespilus germanica</dt>
        <dd>•ğumuşka</dd>
        <dd>•muşmula</dd>

        <dt>Meum athamanticum</dt>
        <dd>•ayuw-rezenesí</dd>

        <dt>Milium effusum</dt>
        <dd>•konakay</dd>
        ...
        <dt>Molinia coerulea</dt>
        <dd>•şîlkîr</dd>

        <dt>Morchella esculenta</dt>
        <dd>•eşek-kómbelegí</dd>

        <dt>Morus</dt>
        <dd>•tut</dd>
        <dd>•balkî</dd>

        <dt>Musa paradisiaca</dt>
        <dd>•muz</dd>

        <dt>Muscari comosum</dt>
        <dd>•ekşí-súmbúl</dd>

        <dt>Myosotis palustris</dt>
        <dd>•kuşkózí</dd>

        <dt>Myosotis silvatica</dt>
        <dd>•unutmamení</dd>

        <dt>Myrica germanica</dt>
        <dd>•ğîlgîn</dd>

        <dt>Myrrhis odorata</dt>
        <dd>•múrsafe</dd>

        <dt>Myrthus pimenta</dt>
        <dd>•yenibahar</dd>
        ...
        <dt>Narcissus angustifolia</dt>
        <dd>•nergis</dd>
        <dd>•zerrinkade</dd>

        <dt>Narcissus poeticus</dt>
        <dd>•biyaz-nergis</dd>

        <dt>Narcissus radiiflorus</dt>
        <dd>•zerrinkade</dd>

        <dt>Nasturtium officinalis</dt>
        <dd>•kerdeme</dd>
        <dd>•suw-teresí</dd>

        <dt>Nasturtium palustre</dt>
        <dd>•órdek-kerdemesí</dd>
        <dd>•órdek-teresí</dd>

        <dt>Nepeta cataria</dt>
        <dd>•mîşîk-nanesí</dd>

        <dt>Nerium oleander</dt>
        <dd>•aguw</dd>
        <dd>•aguwdalî</dd>
        <dd>•zakkum</dd>

        <dt>Nicotiana alata</dt>
        <dd>•kanatlî-tútún</dd>

        <dt>Nicotiana tabacum</dt>
        <dd>•tútún</dd>

        <dt>Nigella arvensis</dt>
        <dd>•kîr-şórekotî</dd>

        <dt>Nigella sativa</dt>
        <dd>•şórekotî</dd>
        ...
        <dt>Nymphaea lotus</dt>
        <dd>•lotus</dd>
        <dd>•suw-zambagî</dd>

        <dt>Nymphoides peltata</dt>
        <dd>•sarî-lotus</dd>
        <dd>•sarî-suw-zambagî</dd>

        <dt>Ocimum basilicum</dt>
        <dd>•feslegen</dd>
        <dd>•reyhan</dd>

        <dt>Oenanthe aquatica</dt>
        <dd>•suw-rezenesí</dd>

        <dt>Oenothera biennis</dt>
        <dd>•eşekotî</dd>
        <dd>•ğarîkotî</dd>

        <dt>Oenothera communis</dt>
        <dd>•eşekotî</dd>
        <dd>•ğarîkotî</dd>
        ...
        <dt>Onobrychis caput galli</dt>
        <dd>•korazbaşî</dd>
        <dd>•korînga</dd>

        <dt>Onobrychis viciaefolia</dt>
        <dd>•korazbaşî</dd>
        <dd>•korînga</dd>

        <dt>Ononis spinosa</dt>
        <dd>•kayîşkîrgan</dd>

        <dt>Onopordon acanthium</dt>
        <dd>•mandalak</dd>

        <dt>Ophioglossum vulgatum</dt>
        <dd>•ğîlan-tóşegí</dd>

        <dt>Opuntia ficus indica</dt>
        <dd>•kaktus-ínğírí</dd>

        <dt>Orchis anthropophora</dt>
        <dd>•insan-salebí</dd>

        <dt>Orchis mascula</dt>
        <dd>•túrúk-salebí</dd>

        <dt>Orchis militaris</dt>
        <dd>•şapkalî-salep</dd>

        <dt>Orchis morio</dt>
        <dd>•salep</dd>

        <dt>Orchis palustre</dt>
        <dd>•bataklîk-salebí</dd>

        <dt>Orchis papilionacea</dt>
        <dd>•gómelek-salebí</dd>

        <dt>Orchis purpurea</dt>
        <dd>•liyla-salep</dd>

        <dt>Origanum majorana</dt>
        <dd>•merğankeş</dd>
        <dd>•merzene</dd>

        <dt>Origanum vulgare</dt>
        <dd>•dostotî</dd>
        <dd>•kíyewotî</dd>

        <dt>Ornithogalum pyrenaicum</dt>
        <dd>•tegeneklí-akyîldîz-soganî</dd>

        <dt>Ornithogalum umbellatum</dt>
        <dd>•akyîldîz-soganî</dd>
        ...
        <dt>Oxalis acetosella</dt>
        <dd>•ekşí-úşgúl</dd>
        <dd>•ekşí-yonğa</dd>

        <dt>Oxycoccus quadripetalus</dt>
        <dd>•tolana</dd>

        <dt>Paeonia officinalis</dt>
        <dd>•ayuw-gúlí</dd>
        <dd>•şakayîk</dd>

        <dt>Paliurus spina-christi</dt>
        <dd>•kara-şeneşke</dd>
        ...
        <dt>Panicum miliaceum</dt>
        <dd>•tarî</dd>

        <dt>Panicum sanguinale</dt>
        <dd>•pağay</dd>

        <dt>Papaver rhoeas</dt>
        <dd>•kelínşekşeşegí</dd>
        <dd>•afiyon</dd>
        <dd>•haşhaş</dd>

        <dt>Papaver somniferum</dt>
        <dd>•kelínşekşeşegí</dd>
        <dd>•afiyon</dd>
        <dd>•haşhaş</dd>

        <dt>Parietaria erecta</dt>
        <dd>•ğabîşmaotî</dd>

        <dt>Parietaria officinalis</dt>
        <dd>•ğabîşmaotî</dd>

        <dt>Paris quadrifolia</dt>
        <dd>•talakdermanî</dd>
        <dd>•túlkí-yúzúmí</dd>

        <dt>Parnassia palustris</dt>
        <dd>•ğúrekyapragî</dd>

        <dt>Passiflora incarnata</dt>
        <dd>•sáátşeşegí</dd>
        <dd>•yîkpaltegerşígí</dd>

        <dt>Pastinaca sativa hortensis</dt>
        <dd>•ak-keşír</dd>
        <dd>•aktamîr</dd>
        <dd>•aktazîl</dd>

        <dt>Paullinia cupana</dt>
        <dd>•guwarana</dd>

        <dt>Paullinia sorbilis</dt>
        <dd>•guwarana</dd>

        <dt>Pedicularis campestris</dt>
        <dd>•bitotî</dd>

        <dt>Pedicularis verticillata</dt>
        <dd>•kúntayaklî-bitotî</dd>

        <dt>Pelargonium odoratissimum</dt>
        <dd>•atîrşak</dd>
        <dd>•îtîrşeşegí</dd>

        <dt>Persea gratissima</dt>
        <dd>•avokado</dd>

        <dt>Persica vulgaris</dt>
        <dd>•şeftalí</dd>

        <dt>Petasites hybridus</dt>
        <dd>•buruntîotî</dd>
        <dd>•kulunşotî</dd>
        <dd>•vebaotî</dd>

        <dt>Petasites officinalis</dt>
        <dd>•buruntîotî</dd>
        <dd>•kulunşotî</dd>
        <dd>•vebaotî</dd>

        <dt>Petroselinum hortense</dt>
        <dd>•ğepare</dd>
        <dd>•megdúnez</dd>

        <dt>Petunia hybrida</dt>
        <dd>•petuniya</dd>

        <dt>Phalaris canariensis</dt>
        <dd>•kuşğemí</dd>

        <dt>Pharbitis purpurea</dt>
        <dd>•borazanşeşegí</dd>

        <dt>Phaseolus vulgaris</dt>
        <dd>•pakla</dd>

        <dt>Phellandrium aquaticum</dt>
        <dd>•suw-rezenesí</dd>

        <dt>Philadelphus coronarius</dt>
        <dd>•filbahar</dd>

        <dt>Phleum pratense</dt>
        <dd>•kelepotî</dd>

        <dt>Phoenix dactylifera</dt>
        <dd>•kurma</dd>

        <dt>Phragmites australis</dt>
        <dd>•kamîş</dd>
        <dd>•saz</dd>
        <dd>•kargî</dd>
        <dd>•suwşerítí</dd>

        <dt>Phragmites communis</dt>
        <dd>•kamîş</dd>
        <dd>•saz</dd>
        <dd>•kargî</dd>
        <dd>•suwşerítí</dd>

        <dt>Phyllitis scolopendrium</dt>
        <dd>•kíyíktílí</dd>

        <dt>Physalis alkekengi</dt>
        <dd>•kíyewfenerí</dd>

        <dt>Phyteuma orbiculare</dt>
        <dd>•pulşeşegí</dd>
        ...
        <dt>Pilocarpus jaborandi</dt>
        <dd>•yaborandiy</dd>

        <dt>Pimenta dioica</dt>
        <dd>•yenibahar</dd>

        <dt>Pimenta officinalis</dt>
        <dd>•yenibahar</dd>

        <dt>Pimpinella anisum</dt>
        <dd>•enison</dd>
        <dd>•anason</dd>
        <dd>•nanehan</dd>

        <dt>Pimpinella saxifraga</dt>
        <dd>•kanaraotî</dd>
        <dd>•kanara-nanehanî</dd>
        <dd>•kanara-enisonî</dd>
        <dd>•kanara-anasonî</dd>

        <dt>Pinguicula alpina</dt>
        <dd>•sarîmayotî</dd>

        <dt>Pinguicula vulgaris</dt>
        <dd>•sarîmayotî</dd>

        <dt>Pinus maritima</dt>
        <dd>•kum-şamî</dd>
        <dd>•kum-kadîsî</dd>
        ...
        <dt>Pinus silvestris</dt>
        <dd>•şam</dd>
        <dd>•kadî</dd>

        <dt>Piper aromaticum</dt>
        <dd>•kara-búber</dd>
        <dd>•íssíot</dd>

        <dt>Piper cubeba</dt>
        <dd>•hindístan-erígí</dd>
        <dd>•kebabe</dd>
        ...
        <dt>Pisum arvense</dt>
        <dd>•şayîr-mezeliyesí</dd>
        <dd>•şayîr- yeşíl-nogîtî</dd>

        <dt>Pisum elatius</dt>
        <dd>•ğîr-mezeliye</dd>
        <dd>•ğîr- yeşíl-nogît</dd>

        <dt>Pisum sativum</dt>
        <dd>•mezeliye</dd>
        <dd>•yeşíl-nogît</dd>

        <dt>Placodes betulinus</dt>
        <dd>•akterek-kawî</dd>
        <dd>•tozterek-yasî</dd>

        <dt>Plantago lanceolata</dt>
        <dd>•ğaraotî</dd>
        <dd>•bakaotî</dd>

        <dt>Plantago major</dt>
        <dd>•ğalpak-ğaraotî</dd>
        <dd>•ğalpak-bakaotî</dd>

        <dt>Platanus occidentalis</dt>
        <dd>•şarîn</dd>

        <dt>Platanus orientalis</dt>
        <dd>•şarîn</dd>

        <dt>Pleurotus ostreatus</dt>
        <dd>•kara-peşmek</dd>
        ...
        <dt>Polyanthes tuberosa</dt>
        <dd>•súmbúlteber</dd>

        <dt>Polygala vulgaris</dt>
        <dd>•sútotî</dd>

        <dt>Polygonatum multiflorum</dt>
        <dd>•móríotî</dd>

        <dt>Polygonum amfibium</dt>
        <dd>•ğîlga-kuşótmegí</dd>
        <dd>•ğîlga-torsîgî</dd>

        <dt>Polygonum aviculare</dt>
        <dd>•kuşótmegí</dd>
        <dd>•torsîk</dd>

        <dt>Polygonum bistorta</dt>
        <dd>•ğîlanótmegí</dd>

        <dt>Polygonum hydropiper</dt>
        <dd>•suw-búberí</dd>

        <dt>Polygonum viviparum</dt>
        <dd>•ğîlanotî</dd>

        <dt>Polypodium vulgare</dt>
        <dd>•besbaye</dd>

        <dt>Polyporus officinalis</dt>
        <dd>•kaw-mantarî</dd>
        <dd>•şam-mantarî</dd>

        <dt>Polystichum lobatum</dt>
        <dd>•ayuw-tóşegí</dd>
        ...
        <dt>Populus tremula</dt>
        <dd>•kaltîrawuk-kawak</dd>
        <dd>•şalî-kawak</dd>
        <dd>•kaltîrawuk-keleme</dd>

        <dt>Portulaca grandiflora</dt>
        <dd>•sunkay</dd>

        <dt>Portulaca oleracea sativa</dt>
        <dd>•semízotî</dd>

        <dt>Potamogeton natans</dt>
        <dd>•paşa</dd>

        <dt>Potentilla anserina</dt>
        <dd>•kaz-beşparmakotî</dd>
        <dd>•kaztîrnagî</dd>

        <dt>Potentilla argentea</dt>
        <dd>•gúmúş-beşparmakotî</dd>
        <dd>•gúmúşotî</dd>

        <dt>Potentilla chrysantha</dt>
        <dd>•sarî-beşparmakotî</dd>

        <dt>Potentilla erecta</dt>
        <dd>•ğîltîr-beşparmakotî</dd>

        <dt>Potentilla reptans</dt>
        <dd>•kógene-beşparmakotî</dd>

        <dt>Potentilla tormentilla</dt>
        <dd>•beşparmakotî</dd>

        <dt>Poterium sanguisorba</dt>
        <dd>•kíşke-şayîrtúymesí</dd>

        <dt>Primula auricula</dt>
        <dd>•tírmenğíkulagî</dd>

        <dt>Primula elatior</dt>
        <dd>•úyken-ğembeşeşegí</dd>

        <dt>Primula veris</dt>
        <dd>•ğembeşeşegí</dd>

        <dt>Prunella vulgaris</dt>
        <dd>•kertenkelekuyrugî</dd>

        <dt>Prunus amygdalus</dt>
        <dd>•badem</dd>

        <dt>Prunus armeniaca</dt>
        <dd>•kayise</dd>
        <dd>•zerdale</dd>

        <dt>Prunus cerasifera</dt>
        <dd>•erík</dd>

        <dt>Prunus cerasus</dt>
        <dd>•vişne</dd>

        <dt>Prunus domestica</dt>
        <dd>•tuman-erík</dd>

        <dt>Prunus fructicosa</dt>
        <dd>•taw-kirazî</dd>

        <dt>Prunus insititia</dt>
        <dd>•îmît</dd>
        <dd>•merdem</dd>

        <dt>Prunus mahaleb</dt>
        <dd>•karabawur</dd>

        <dt>Prunus padus</dt>
        <dd>•kuş-kirazî</dd>

        <dt>Prunus persica</dt>
        <dd>•şeftalí</dd>

        <dt>Prunus spinosa</dt>
        <dd>•şakal-erígí</dd>
        <dd>•kógem</dd>

        <dt>Pulicaria vulgaris</dt>
        <dd>•búrşeotî</dd>

        <dt>Pulmonaria officinalis</dt>
        <dd>•akğígerotî</dd>
        <dd>•ófkeotî</dd>

        <dt>Pulsatilla montana</dt>
        <dd>•dak-lálesí</dd>

        <dt>Punica grantum</dt>
        <dd>•nar</dd>

        <dt>Pyrus communis</dt>
        <dd>•taw-armutî</dd>
        <dd>•taw-kertpesí</dd>
        ...
        <dt>Quercus petraea</dt>
        <dd>•imen</dd>

        <dt>Quercus pubescens</dt>
        <dd>•túylí-meşe</dd>
        <dd>•túklí-palamut</dd>
        ...
        <dt>Quercus sessiliflora</dt>
        <dd>•imen</dd>

        <dt>Ranunculus acris</dt>
        <dd>•tepreşşeşegí</dd>
        <dd>•turnaayagî</dd>

        <dt>Ranunculus ficaria</dt>
        <dd>•maylîşeşek</dd>

        <dt>Ranunculus repens</dt>
        <dd>•taze-tepreşşeşegí</dd>
        <dd>•taze-turnaayagî</dd>

        <dt>Ranunculus sceleratus</dt>
        <dd>•bataklîk-tepreşşeşegí</dd>
        <dd>•bataklîk-turnaayagî</dd>

        <dt>Raphanus raphanistrum</dt>
        <dd>•ğîr-turup</dd>

        <dt>Raphanus sativus</dt>
        <dd>•turup</dd>

        <dt>Reamuria soongorica Maxim</dt>
        <dd>•budurgana</dd>

        <dt>Rhamnus cathartica</dt>
        <dd>•kíyíkteregí</dd>
        <dd>•ak-şeneşke</dd>

        <dt>Rhamnus frangula</dt>
        <dd>•barutteregí</dd>

        <dt>Rheum officinalis</dt>
        <dd>•rewent</dd>

        <dt>Rhododendron kotschyi</dt>
        <dd>•aguw-gúlí</dd>
        <dd>•komar</dd>

        <dt>Rhus aromatica</dt>
        <dd>•múslí-sumak</dd>

        <dt>Rhus Canadensis</dt>
        <dd>•koşanlî-sumak</dd>

        <dt>Rhus coriaria</dt>
        <dd>•sumak</dd>
        <dd>•daamlatma-sumagî</dd>
        ...
        <dt>Ribes petraeum</dt>
        <dd>•marîl</dd>

        <dt>Ribes rubrum</dt>
        <dd>•karîlgan</dd>

        <dt>Ribes uva-crispa</dt>
        <dd>•şarşay</dd>
        <dd>•kuş-yúzúmí</dd>

        <dt>Ricinus communis</dt>
        <dd>•hindiye</dd>
        <dd>•keneotî</dd>

        <dt>Robinia pseudoacacia</dt>
        <dd>•yalanğî-akasiya</dd>
        <dd>•karakan</dd>
        <dd>•salkîm</dd>
        ...
        <dt>Rosmarinus officinalis</dt>
        <dd>•búberiye</dd>
        <dd>•hasalban</dd>
        <dd>•kuştílí</dd>

        <dt>Rubia tinctorum</dt>
        <dd>•keriyakîrmîzîsî</dd>
        <dd>•kîrmîzîtamîr</dd>

        <dt>Rubus fructicosus</dt>
        <dd>•búldúrgen</dd>
        <dd>•búrlegen</dd>

        <dt>Rubus idaeus</dt>
        <dd>•morîk</dd>
        <dd>•agaş-şeleklígí</dd>

        <dt>Rumex acetosa</dt>
        <dd>•ekşí-atkulak</dd>

        <dt>Rumex acetosella</dt>
        <dd>•ufak-atkulak</dd>

        <dt>Rumex conglomeratus</dt>
        <dd>•ğalpak-atkulak</dd>

        <dt>Rumex crispus</dt>
        <dd>•buruşuk-atkulak</dd>

        <dt>Rumex palustris</dt>
        <dd>•suw-atkulagî</dd>

        <dt>Rumex patientia</dt>
        <dd>•ğalpak-atkulak</dd>

        <dt>Ruscus aculeatus</dt>
        <dd>•koyanmemesí</dd>
        <dd>•ólmez-tegenek</dd>
        ...
        <dt>Ruta graveolens</dt>
        <dd>•kokarşeref</dd>
        <dd>•sedefotî</dd>

        <dt>Sabadilla officinalis</dt>
        <dd>•papazotî</dd>
        <dd>•popazotî</dd>
        <dd>•bit-zambagî</dd>

        <dt>Sabina officinalis</dt>
        <dd>•zerlí-ardîş</dd>
        <dd>•kara-arğa</dd>
        <dd>•sasîk-arşa</dd>

        <dt>Saccharomyces cerevisiae</dt>
        <dd>•biramayasî</dd>

        <dt>Saccharum officinale</dt>
        <dd>•şeker-kamîşî</dd>

        <dt>Salicornia herbaceea</dt>
        <dd>•búberşík</dd>
        ...
        <dt>Salix babylonica</dt>
        <dd>•kuyulgan-burgas</dd>
        <dd>•ğîlar-sewet</dd>
        <dd>•kuyulgan-tal</dd>
        <dd>•ğîlar-torak</dd>
        ...
        <dt>Salix viminalis</dt>
        <dd>•burgas</dd>
        <dd>•sewet</dd>
        <dd>•tal</dd>
        <dd>•torak</dd>

        <dt>Salix vitellina</dt>
        <dd>•sarî-burgas</dd>
        <dd>•sarî-sewet</dd>
        <dd>•sarî-tal</dd>
        <dd>•sarî-torak</dd>
        ...
        <dt>Salvia aethiopis</dt>
        <dd>•túylí-adaşayî</dd>
        <dd>•túklí-selbe</dd>

        <dt>Salvia glutinosa</dt>
        <dd>•ğabîşkan-adaşayî</dd>
        <dd>•ókselí-selbe</dd>

        <dt>Salvia officinalis</dt>
        <dd>•adaşayî</dd>
        <dd>•selbe</dd>

        <dt>Salvia sclarea</dt>
        <dd>•múslí-adaşayî</dd>

        <dt>Sambucus ebulus</dt>
        <dd>•boz-kendelaş</dd>
        <dd>•zerlí-múrver</dd>
        <dd>•boz-torîslaş</dd>
        ...
        <dt>Sanguisorba minor</dt>
        <dd>•kíşke-şayîrtúymesí</dd>

        <dt>Sanguisorba officinalis</dt>
        <dd>•balaban-şayîrtúymesí</dd>

        <dt>Sanicula europea</dt>
        <dd>•dermanotî</dd>
        <dd>•dewekulagî</dd>

        <dt>Santalum album</dt>
        <dd>•ak-santal</dd>

        <dt>Saponaria officinalis</dt>
        <dd>•çúyún</dd>
        <dd>•kolagaşî</dd>
        <dd>•sabînotî</dd>
        <dd>•şogan</dd>

        <dt>Saponaria vaccaria</dt>
        <dd>•tanasabînî</dd>

        <dt>Sarothamnus scoparius</dt>
        <dd>•sîpîrga-katîrtîrnagî</dd>

        <dt>Sassafras albidum</dt>
        <dd>•sasafras</dd>

        <dt>Sassafras officinalis</dt>
        <dd>•sasafras</dd>

        <dt>Satureja hortensis</dt>
        <dd>•kíyíkotî</dd>
        <dd>•şól-nane</dd>
        <dd>•sater</dd>

        <dt>Saxifraga adscendens</dt>
        <dd>•súmsúle</dd>

        <dt>Saxifraga aizoon</dt>
        <dd>•taşğargan</dd>

        <dt>Scabiosa ochroleuca</dt>
        <dd>•uyuzotî</dd>

        <dt>Scandix odorata</dt>
        <dd>•múrsafe</dd>

        <dt>Scandix pecten veneris</dt>
        <dd>•kelíntaragî</dd>

        <dt>Schinus molle</dt>
        <dd>•yalanğî-búber</dd>

        <dt>Schoenoplectus lacustris</dt>
        <dd>•kîyak</dd>
        <dd>•şakan</dd>

        <dt>Scilla maritima</dt>
        <dd>•ada-soganî</dd>

        <dt>Scirpus holoschoenus</dt>
        <dd>•mîğa</dd>
        <dd>•şakan</dd>

        <dt>Scirpus maritimus</dt>
        <dd>•koga</dd>
        <dd>•şegen</dd>

        <dt>Scirpus silvaticus</dt>
        <dd>•kasîrşîk</dd>

        <dt>Scleranthus annuus</dt>
        <dd>•karînşatlagîotî</dd>

        <dt>Scleranthus perennis</dt>
        <dd>•uzunómírlí-karînşatlagîotî</dd>

        <dt>Scolopendrium vulgare</dt>
        <dd>•kíyíktílí</dd>

        <dt>Scopolia carniolica</dt>
        <dd>•delíotî</dd>

        <dt>Scrophularia nodosa</dt>
        <dd>•şifalî-sîrağaotî</dd>

        <dt>Scrophularia scopolii</dt>
        <dd>•sîrağaotî</dd>

        <dt>Secale cereale</dt>
        <dd>•şawdar</dd>

        <dt>Secale cornutum</dt>
        <dd>•kaşkîrtíşí</dd>
        <dd>•şawdarmahmuzî</dd>

        <dt>Sedum acre</dt>
        <dd>•aşşî-kaya-korîgî</dd>
        <dd>•aşşî-mayotî</dd>

        <dt>Sedum fabaria</dt>
        <dd>•pembe-kaya-korîgî</dd>
        <dd>•pembe-mayotî</dd>
        ...
        <dt>Sedum rosea</dt>
        <dd>•kîrmîzî-kaya-korîgî</dd>
        <dd>•kîrmîzî-mayotî</dd>

        <dt>Sedum telephinum</dt>
        <dd>•kaya-korîgî</dd>
        <dd>•mayotî</dd>

        <dt>Selenicereus grandiflorus</dt>
        <dd>•kaktus</dd>
        <dd>•kaynanatílí</dd>

        <dt>Sempervivum soboliferum</dt>
        <dd>•nasîrotî</dd>

        <dt>Sempervivum tectorum</dt>
        <dd>•şaşaklîk-korîgî</dd>
        <dd>•kulakotî</dd>

        <dt>Senecio rupester</dt>
        <dd>•kanariyaotî</dd>

        <dt>Senecio vernalis</dt>
        <dd>•baárlík-kanariyaotî</dd>

        <dt>Senecio vulgaris</dt>
        <dd>•kanariyaotî</dd>

        <dt>Senna officinalis</dt>
        <dd>•sinameke</dd>

        <dt>Sesamum indicium</dt>
        <dd>•kónğet</dd>
        <dd>•susam</dd>

        <dt>Sesamum orientale</dt>
        <dd>•kónğet</dd>
        <dd>•susam</dd>

        <dt>Setaria verticillata</dt>
        <dd>•kuş-burşagî</dd>

        <dt>Sherardia arvensis</dt>
        <dd>•keriyağezí</dd>

        <dt>Sideritis montana</dt>
        <dd>•dakşayî</dd>

        <dt>Silybium marianum</dt>
        <dd>•dewe-tegenegí</dd>

        <dt>Simmondsia chinesis</dt>
        <dd>•jojoba</dd>

        <dt>Sinapis alba</dt>
        <dd>•biyaz-hardal</dd>

        <dt>Sinapis arvensis</dt>
        <dd>•ğîr-hardal</dd>

        <dt>Sinapis nigra</dt>
        <dd>•kara-hardal</dd>

        <dt>Sisymbrium loeselii</dt>
        <dd>•kíşkene-búlbúlotî</dd>

        <dt>Sisymbrium officinale</dt>
        <dd>•búlbúlotî</dd>

        <dt>Smilax medica</dt>
        <dd>•saparna</dd>

        <dt>Smilax officinalis</dt>
        <dd>•saparna</dd>

        <dt>Smilax sarsaparilla</dt>
        <dd>•saparna</dd>

        <dt>Solanum dulcamara</dt>
        <dd>•talakotî</dd>
        <dd>•sofîr</dd>

        <dt>Solanum lycopersicum</dt>
        <dd>•domatis</dd>
        <dd>•turşuluk-domatis</dd>

        <dt>Solanum melongea</dt>
        <dd>•patlîğan</dd>

        <dt>Solanum nigrum</dt>
        <dd>•kara-talakotî</dd>
        <dd>•kara-sofîr</dd>
        <dd>•it-yúzúmí</dd>
        ...
        <dt>Solidago virgaurea</dt>
        <dd>•búyrekotî</dd>
        <dd>•altînmaşak</dd>

        <dt>Sonchus oleraceus</dt>
        <dd>•kertenkelesútí</dd>
        ...
        <dt>Sorbus aucuparia</dt>
        <dd>•kuş-armutî</dd>

        <dt>Sorbus domestica</dt>
        <dd>•úwez</dd>

        <dt>Sorghum saccharatum</dt>
        <dd>•tatlî-ğúgúre</dd>
        <dd>•tatlî-sîpîrgaotî</dd>

        <dt>Sorghum sudanense</dt>
        <dd>•sudanotî</dd>

        <dt>Sorghum vulgare</dt>
        <dd>•ğúgúre</dd>
        <dd>•sîpîrgaotî</dd>

        <dt>Sparganium ramosum</dt>
        <dd>•şokmar</dd>

        <dt>Spartium junceum</dt>
        <dd>•sîpîrga-katîrtîrnagî</dd>

        <dt>Spinacia oleracea</dt>
        <dd>•îspanak</dd>

        <dt>Spiraea crenata</dt>
        <dd>•tawulga</dd>

        <dt>Spiraea salicifolia</dt>
        <dd>•tawulga</dd>

        <dt>Spiraea ulmifolia</dt>
        <dd>•balgîna</dd>

        <dt>Spiraea vanhouttei</dt>
        <dd>•súsken</dd>

        <dt>Stachys germanica</dt>
        <dd>•koyan-kesteresí</dd>

        <dt>Stachys lanata</dt>
        <dd>•ğún-kesteresí</dd>

        <dt>Stachys officinalis</dt>
        <dd>•kestere</dd>

        <dt>Stachys silvatica</dt>
        <dd>•taw-kesteresí</dd>

        <dt>Statice gmelini</dt>
        <dd>•şîtîrgî</dd>

        <dt>Stellaria media</dt>
        <dd>•kuşotî</dd>

        <dt>Stipa capillata</dt>
        <dd>•pakra</dd>

        <dt>Stipa consanguinea</dt>
        <dd>•kîlgana</dd>

        <dt>Stipa pennata</dt>
        <dd>•túklí-pakra</dd>

        <dt>Stipa tenacissima</dt>
        <dd>•túrtken-pakra</dd>

        <dt>Stratiotes aloides</dt>
        <dd>•aksabîr</dd>

        <dt>Strychnos nux-vomica</dt>
        <dd>•kargakózí</dd>

        <dt>Styrax officinalis</dt>
        <dd>•asîlşîra</dd>

        <dt>Swietenia mahagoni</dt>
        <dd>•mahun</dd>

        <dt>Symphoricarpus albus</dt>
        <dd>•karğemíşí</dd>

        <dt>Symphytum officinalis</dt>
        <dd>•eşekkulagî</dd>
        <dd>•karakafes</dd>

        <dt>Syringa vulgaris</dt>
        <dd>•liylak</dd>

        <dt>Syzygium aromaticum</dt>
        <dd>•kalampîr</dd>

        <dt>Tamarindus indica</dt>
        <dd>•hint-kurmasî</dd>
        <dd>•temírhint</dd>

        <dt>Tamarix germanica</dt>
        <dd>•ğîlgîn</dd>

        <dt>Tamarix ramosissima</dt>
        <dd>•súksúk</dd>

        <dt>Tamus communis</dt>
        <dd>•kara-asma</dd>

        <dt>Tanacetum alpinum</dt>
        <dd>•dak-ateşotî</dd>
        <dd>•dak-gúmúştúymesí</dd>

        <dt>Tanacetum balsamita</dt>
        <dd>•belseme</dd>

        <dt>Tanacetum cinerariaefolium</dt>
        <dd>•boz-búrşeotî</dd>

        <dt>Tanacetum indicum</dt>
        <dd>•krizantema</dd>

        <dt>Tanacetum leucanthemum</dt>
        <dd>•ógízkózí</dd>
        <dd>•pat</dd>

        <dt>Tanacetum parthenium</dt>
        <dd>•ateşotî</dd>
        <dd>•gúmúştúyme</dd>

        <dt>Tanacetum vulgare</dt>
        <dd>•şîlawşanotî</dd>

        <dt>Taraxacum officinalis</dt>
        <dd>•aslantíşí</dd>
        <dd>•kara-hindiba</dd>
        <dd>•şînğîrotî</dd>
        <dd>•úpúrúkşeşegí</dd>
        ...
        <dt>Teucrium chamaedrys</dt>
        <dd>•kîskamahmutotî</dd>

        <dt>Teucrium montanum</dt>
        <dd>•dak-kîskamahmutotî</dd>

        <dt>Teucrium scordium</dt>
        <dd>•kutlîot</dd>
        <dd>•şolgay</dd>
        ...
        <dt>Theobroma cacao</dt>
        <dd>•kakao</dd>

        <dt>Thlaspi arvense</dt>
        <dd>•şobankísesí</dd>

        <dt>Thuja orientalis</dt>
        <dd>•mazî</dd>
        <dd>•sawur</dd>

        <dt>Thymus serpyllum</dt>
        <dd>•şól-keklíkotî</dd>

        <dt>Thymus vulgaris</dt>
        <dd>•aslî-keklíkotî</dd>

        <dt>Tilia sp.</dt>
        <dd>•ğóke</dd>

        <dt>Tragopogon major</dt>
        <dd>•eşkísakalî</dd>

        <dt>Tragopogon pratensis</dt>
        <dd>•eşkísakalî</dd>

        <dt>Trametes suaveolens</dt>
        <dd>•torak-asî</dd>
        <dd>•tal-yasî</dd>
        <dd>•burgas-kawî</dd>
        <dd>•sewet-meşkesí</dd>

        <dt>Tribulus terrestris</dt>
        <dd>•deweğîkkan</dd>

        <dt>Trifolium arvense</dt>
        <dd>•gómelekotî</dd>

        <dt>Trifolium campestre</dt>
        <dd>•kîr-úşgúlí</dd>
        <dd>•kîr-yonğasî</dd>

        <dt>Trifolium pratense</dt>
        <dd>•şayîr-úşgúlí</dd>
        <dd>•kîrmîzî-yonğa</dd>

        <dt>Trifolium repens</dt>
        <dd>•ak-úşgúl</dd>
        <dd>•ak-yonğa</dd>

        <dt>Trigonella besseriana</dt>
        <dd>•boyotî</dd>

        <dt>Trigonella foenum graecum</dt>
        <dd>•çemen</dd>
        <dd>•şemen</dd>
        <dd>•kúlbe</dd>
        <dd>•múslí-yonğa</dd>

        <dt>Triticum aestivum</dt>
        <dd>•biyday</dd>
        <dd>•kîzîlşa</dd>

        <dt>Triticum durum</dt>
        <dd>•makoron-biydayî</dd>
        <dd>•makoron-kîzîlşasî</dd>

        <dt>Trollius europeaeus</dt>
        <dd>•karîlgaşetegí</dd>
        <dd>•sarî-kópík</dd>

        <dt>Tropaeolum majus</dt>
        <dd>•láden</dd>
        <dd>•láden-teresí</dd>

        <dt>Tulipa gesneriana</dt>
        <dd>•lále</dd>

        <dt>Tussilago farfara</dt>
        <dd>•óksíríkotî</dd>
        <dd>•botatabanî</dd>

        <dt>Tussilago petasites</dt>
        <dd>•buruntîotî</dd>
        <dd>•kulunşotî</dd>
        <dd>•vebaotî</dd>

        <dt>Typha angustifolia</dt>
        <dd>•kofa</dd>
        <dd>•suwşerítí</dd>

        <dt>Ulex europaeus</dt>
        <dd>•tegeneklí-katîrtîrnagî</dd>

        <dt>Ulmus campestris</dt>
        <dd>•elme</dd>

        <dt>Uncaria gambir</dt>
        <dd>•mide-asmasî</dd>

        <dt>Uragoga ipecacuanha</dt>
        <dd>•altîntamîr</dd>
        <dd>•kusmatamîrî</dd>
        <dd>•ipeka</dd>

        <dt>Urginea maritima</dt>
        <dd>•ada-soganî</dd>
        ...
        <dt>Urtica urens</dt>
        <dd>•kíşke-dîzlagan</dd>
        <dd>•ufak-kîşîtkan</dd>
        <dd>•kíşke-şalkanak</dd>

        <dt>Usnea barbata</dt>
        <dd>•sakal-şibiyesí</dd>
        <dd>•sakal-yasî</dd>

        <dt>Utricularia vulgaris</dt>
        <dd>•sîzanakotî</dd>

        <dt>Vaccinium myrtillus</dt>
        <dd>•alîrşa</dd>
        <dd>•núre</dd>
        <dd>•torbas</dd>
        <dd>•şayîr-mersiní</dd>

        <dt>Vaccinium oxycoccos</dt>
        <dd>•tolana</dd>

        <dt>Vaccinium vitis idaea</dt>
        <dd>•alîrkan</dd>
        <dd>•merğanî</dd>
        <dd>•kîrmîzî-şayîr-mersiní</dd>

        <dt>Valeriana officinalis</dt>
        <dd>•mîşîkotî</dd>

        <dt>Valerianella locusta</dt>
        <dd>•kozî-salatasî</dd>

        <dt>Vallisneria spiralis</dt>
        <dd>•bataklîk-arpasî</dd>

        <dt>Vanilla planifolia</dt>
        <dd>•vaniliya</dd>

        <dt>Veratrum album</dt>
        <dd>•ak-şópleme</dd>

        <dt>Veratrum nigrum</dt>
        <dd>•kara-şópleme</dd>

        <dt>Veratrum viride</dt>
        <dd>•yeşíl-şópleme</dd>

        <dt>Verbascum nigrum</dt>
        <dd>•kara-ğalba</dd>
        <dd>•kara-sîyîrkuyrugî</dd>

        <dt>Verbascum phlomoides</dt>
        <dd>•túylí-ğalba</dd>
        <dd>•túylí-sîyîrkuyrugî</dd>

        <dt>Verbascum thapsus</dt>
        <dd>•wakşeşeklí-ğalba</dd>
        <dd>•wakşeşeklí-sîyîrkuyrugî</dd>

        <dt>Verbena officinalis</dt>
        <dd>•mineotî</dd>
        <dd>•suw-nergisí</dd>

        <dt>Veronica beccabunga</dt>
        <dd>•suw-ezení</dd>

        <dt>Veronica officinalis</dt>
        <dd>•ezen</dd>

        <dt>Viburnum lantana</dt>
        <dd>•balan</dd>
        ...
        <dt>Vinca herbacea</dt>
        <dd>•Ğezayir-menewşesí</dd>

        <dt>Vincetoxicum hirundinaria</dt>
        <dd>•karîlgaşkuyrugî</dd>
        <dd>•zerimarotî</dd>
        ...
        <dt>Viola declinata</dt>
        <dd>•búgúk-menewşe</dd>

        <dt>Viola odorata</dt>
        <dd>•múslí-menewşe</dd>

        <dt>Viola tricolor</dt>
        <dd>•alabezek-menewşe</dd>
        ...
        <dt>Vitex agnus castus</dt>
        <dd>•hayît</dd>

        <dt>Vitis hederacea</dt>
        <dd>•asma</dd>

        <dt>Vitis silvestris</dt>
        <dd>•şayîr-yúzúmí</dd>
        ...
        <dt>Xanthium spinosum</dt>
        <dd>•pîtrak</dd>

        <dt>Xanthium strumarium</dt>
        <dd>•uzun-pîtrak</dd>

        <dt>Xanthoxylum piperitum</dt>
        <dd>•Kîtay-búberí</dd>

        <dt>Zea mays</dt>
        <dd>•músúr</dd>

        <dt>Zingiber officinale</dt>
        <dd>•zenğefil</dd>

        <dt>Zinnia elegans</dt>
        <dd>•kírlíkelín</dd>

        <dt>Ziziphus jujuba</dt>
        <dd>•húnnap</dd>
        <dd>•jidgelek</dd>

        <dt>Zostera marina</dt>
        <dd>•deñízğúní</dd>
...
--- Start of Miscellaneous Phrases and Vocabulary ---
- kartiy men kartba (Grandmother and Grandfather)
- balîk man mîşîk (Fish and Cat)
- We şúndí... (And now...)
- Bar mî? (Is there?)
- Ğok mî? (Isn't there?)
- Bílesíñ mí? (Do you know?)
- Árúw mísíñ? (Are you good?)
- ka-teğegín bílmemek (a nu şti ce să se mai facă)
- ğañî bír mutlî sene! (un an nou fericit!)
- ğuwmak v.t. a spăla.
- ğok I. adj. inexistent; absent. II. adv. nu.
- ğîl s. an.
- ğîlan s. şarpe.
...
--- Start of Language Names in Crimean Tatar (RO) ---
- muwallímatşa I. adv. în felul profesorilor; ca profesorii. II. s. limbaj academic.
- japonğa I. adv. în limba japoneză. II. s. (limba) japoneză.
- koreğe I. adv. în limba coreeană. II. s. (limba) coreeană.
- tajikşe I. adv. în limba tadjikă. II. s. (limba) tadjikă.
- túrkmenğe I. adv. în limba turkmenă. II. s. (limba) turkmenă.
- letonğa I. adv. în limba letonă. II. s. (limba) letonă.
- hîrwatşa I. adv. în limba croată. II. s. (limba) croată.
- kazawğa I. adv. în limba kazahă. II. s. (limba) kazahă.
- ózbekşe I. adv. în limba uzbecă. II. s. (limba) uzbecă.
- kazahşa I. adv. în limba kazahă. II. s. (limba) kazahă.
- sanskritşe I. adv. în limba sanscrită. II. s. (limba) sanscrită.
- lawğa I. adv. în limba laoţiană. II. s. (limba) laoţiană.
...
yas I. num. (mong.) nouă. II. s. (bot.) iască (lat., Fomes igniarius). 1. muşchi; lichen; algă; ciupercă. III. s., adj. (ist.) scit; câmpean; crimean; locuitor al stepei; ; membru al uniunii celor nouă neamuri nobile.
Lituwaniye
s. (topon.) Lituania.
Lúbnan
s. (topon.) Liban.
...
export const CRIMEAN_TATAR_RO_VOWEL_HARMONY_INFO = `
...
export const CRIMEAN_TATAR_RO_PHONETIC_CHANGES_INFO = `
...
- g > k
- ğ > ç (e.g., tağ > taç 'crown') - Note: this 'ç' is from devoicing /dʒ/, not the SCT /tʃ/ sound.
- v > f (academic sounds)
...
- ç ~ ş: şeşek (Tatar) ~ çiçek (Turkish); şoban (Tatar) ~ çoban (Turkish) (DT prefers ş)
- s ~ ş: şáş (Tatar) ~ saç (Turkish)
- m ~ b: men (Tatar) ~ ben (Turkish)
These pairs reflect Turkic language variations.
`;

export const CRIMEAN_TATAR_RO_SYLLABLE_STRUCTURE_INFO = `
...
export const CRIMEAN_TATAR_RO_BIRD_NAMES_TABLE = `
--- Start of Crimean Tatar (RO) Bird Names Table (Latin, Dobrujan Tatar, Romanian, English) ---
Latin Name; Dobrujan Tatar; Romanian; English
Acanthis cannabina; ketenkuşî, kînapkuşî, kendírkuşî; Cânepar; Common Linnet
Accipiter nisus; torgay-atmağasî, kíşkene-atmağa, boz-dogan, şunkar; Uliu păsărar; Eurasian Sparrowhawk
Alauda arvensis; balşmîr, boztorgay, tarla-torgayî, kergen; Ciocârlie de câmp; Eurasian Skylark
Alcedo atthis; kók-balîkşî; Pescăruș albastru; Common Kingfisher
Anas platyrhynchos; yeşílbaş-órdek, yeşílbaş; Rață mare; Mallard
Anser anser; ak-kaz, boz-kaz; Gâscă de vară; Greylag Goose
Apus apus; kara-surkarlîgaş; Drepnea neagră; Common Swift
Aquila chrysaetos; altîn-şoñgîr, kaya-şoñgîrî, kral-şoñgîr; Acvilă de munte, Pajură; Golden Eagle
Ardea cinerea; kúlrengí-karkara, kúlrengí-şapur; Stârc cenuși; Grey Heron
Asio otus; uzun-kulaklî-baykuş; Ciuf de pădure; Long-eared Owl
Athene noctua; kíşkene-baykuş, yapalak; Cucuvea; Little Owl
Bubo bubo; baykuş; Buhă mare; Eurasian Eagle-Owl
Carduelis carduelis; kankalkuşî, altîn-şîmşîk; Sticlete; European Goldfinch
Columba domestica; kógerşín, kepter; Porumbel de casă; Domestic Pigeon
Columba palumbus; yakalî-kógerşín; Porumbel gulerat; Common Wood Pigeon
Corvus corax; ker, kuzgun, kuzgî, zakşa; Corb; Common Raven
Corvus corone; leş-kargasî; Cioară grivă / Cioară neagră; Carrion/Hooded Crow
Corvus frugilegus; egín-kargasî, tokîm-kargasî; Cioară de semănătură; Rook
Corvus monedula; dolaşa, şáwke; Stăncuță; Western Jackdaw
Coturnix coturnix; bódene, bîldîrğîn; Prepeliță; Common Quail
Cuculus canorus; kukuk, kukuw; Cuc; Common Cuckoo
Cygnus olor; kuw, ak-kuw; Lebădă de vară; Mute Swan
Falco peregrinus; balaban, dogan, togan, kîrgay, kulta, şahin, láşin; Șoim călător; Peregrine Falcon
Falco tinnunculus; kóykenek, alaşa-dogan, alaşa-togan; Vânturel roșu; Common Kestrel
Fringilla coelebs; ğawrawuk, alaşîray; Cinteză; Common Chaffinch
Gallus gallus domesticus; tawuk, tawkîya; Găină (de casă); Chicken (Domestic Fowl)
Garrulus glandarius; ala-karga, soyga; Gaiță; Eurasian Jay
Grus grus; turna, tokîrawun; Cocor mare; Common Crane
Hirundo rustica; karlîgaş, karîlgaş; Rândunică; Barn Swallow
Larus canus; boz-şaklay, boz-kagay; Pescăruș sur; Mew Gull / Common Gull
Luscinia megarhynchos; búlbúl; Privighetoare roșcată; Common Nightingale
Motacilla alba; ak-şakşakay, ak-kuyruksallar; Codobatură albă; White Wagtail
Passer domesticus; torgay, úy-torgayî, şîmşîk, serşe; Vrabie de casă; House Sparrow
Passer montanus; terek-torgayî; Vrabie de câmp; Eurasian Tree Sparrow
Perdix perdix; kírkík, keklík; Potârniche; Grey Partridge
Phasianus colchicus; kîrkawul, súlgún; Fazan; Common Pheasant
Pica pica; sawuskan; Coțofană; Eurasian Magpie
Sturnus vulgaris; sîradan-şîyîrşîk, sîradan-şegertkíğí; Graur; Common Starling
Sylvia atricapilla; kara-başlî-ğeleşe, karabaş; Silvie cu cap negru; Eurasian Blackcap
...
export const CRIMEAN_TATAR_RO_COMPREHENSIVE_GRAMMAR_DETAILS = `
...
tíşle (tooth-vb) "bite"
karar (black-vb) "become black"
keşík (late-vb) "be late"

Bare verb stems can also be compounded with noun stems to create new verbs, as in:
şekele (pull-carry-vb) "to overhaul"
...
Tense/Aspect        Marker  Negation    Person Marker   Example
General Present     -A/y    -mAy        pronominal      alaman ("I take")
Present Progressive -mAKtA  -mA         pronominal      ğazmaktamîz ("We are writing.")
Future/Present      -Ar/Ir  -mAz        pronominal      bakîrîrman ("I will yell.")
Categorical Future  -ğAK    -mAy        pronominal      alağakman ("I will [probably] take") Note: -cAK becomes -ğAK
General Past        -DY     -mA         possessive      Kîrîmga keldík ("We returned to Crimea.")
Evidential Past     -KAn    -mA         pronominal      bergenler ("they [apparently] gave")
Conditional         -sA     -mA         possessive      alsam ("if I take")

A separate set of compound tenses are formed by adding the past tense copula edí- to the derived forms listed above.

Compound Tense      Formed With         Negation    Example
Habitual Past       Future/Present      -mAz        alîr edím ("I often used to take")
Compound Past       General Present     -A/y        ala edík ("we were taking")
Pluperfect          Evidential Past     -mA         algan edím ("I had taken")
Counterfactual Past Categorical Future  -mA         yazağak edím ("I would have written")
Progressive Past    Progressive         -mA         Ketmekte edím. ("I kept going.")
Past Conditional    Conditional         -mA         alsa edím ("if I had taken")
...
Unutayîm "I should have to forget."
Unut! "Forget!"
Unutsîn. "Let him/her forget."

Other moods are constructed similarly to tense/aspect forms.

Mood        Marker      Negation    Person Marker   Example
Optative    -KAy(dI)    -mAy        pronominal      Aytkaydîm ("I wish I had spoken.")
Obligative  -mAlY       -mA         possessive      Aytmalîman ("I have to speak.")
...
Reflexive   -(I)n   bogîl ("drown oneself")
Reciprocal  -(I)ş   tapîş ("find each other")
 
Causative   Marker  Added To                        Example
-t          polysyllabic stems ending in vowel  íşlet ("force to work")
-It         stems ending in -rk, -lk, -k        korkît ("to scare [someone]")
-Ir         monosyllabic stems ending in -t, -ç, -ş uşîr ("allow to fly away")
-Ar         monosyllabic stems                  kopar ("break off [something]")
-DIrm       most remaining stems                tóktír ("force to spill")
...
Participle  Marker  Negation
Past        -KAn    -mA
Future      -ğAK    -mAy
Present     -r      -mAz

ğazîlgan mektúp (write-ptcp.past letter) "written letter"
sînağak araba (break-ptcp.fut cart) "cart that will break"
ğanar taw (burn-ptcp.pres forest) "burning forest"

Copula

The copula ol ("to be, become, exist") is generally expressed as a predicate suffix in the present tense, closely resembling the pronominal person endings, as displayed below. The third person endings are frequently deleted in colloquial speech. The copula’s past tense form, edí, is suppletive. Future tense copular forms are constructed by the addition of the categorical future suffix -ğAK.
...
Men hoğa bolğakman. (I teacher cop.fut.1sg) "I will be a teacher."
...
Hasan úyge kelíp úyní temízledí.
(Hasan house-dat come-cvb.past house-acc clean-vb-past)
"Hasan came home and cleaned the house."
...
Deverbal
Marker  Meaning                 Example                 Gloss
-mA     result of action        aşîkma ("a hurry")      hurry-SUF
-KI     instrument of action    bílgí ("knowledge")     know-SUF
-KIş    utility of action       tutkîş ("holder, handle") hold-SUF
-I      general noun formation  ólí ("dead man")        die-SUF
-(I)k   general noun formation  kúrek ("shovel")        scoop-SUF
-(U)v   general noun formation  kuruw ("building")      build-SUF
...
kartop-martop (potato-redup) "potatoes and the like"
ana-baba (mother-father) "parents"
...
arabalar (car-pl) "cars"

Use of the plural can also express respect, as in:
Osmanovlar keldí. "Osmanov came."
...
balam (child-1sg.poss-nom) "my child"
balañ (child-2sg.poss-nom) "your child"
balasî (child-3sg.poss-nom) "his/her child"
...
Case        Suffix  Example with bala ("child")
Nominative  Ø       bala ("the child" [subject])
Accusative  -nY     balanî ("the child" [direct object])
Genitive    -nYñ    balanîñ ("of the child")
Dative      -KA     balaga ("to the child")
...
Nominative  men     sen     o           bíz     síz     olar/onlar
Accusative  mení    sení    onî         bízní    sízní    olarnî/onlarnî
Genitive    mením   seníñ   onîñ        bízím    sízíñ    olarnîñ/onlarnîñ
Dative      maga    saga    oga         bízge    sízge    olarga/onlarga
Locative    mende   sende   onda        bízde    sízde    olarda/onlarda
Ablative    menden  senden  ondan       bízden   sízden   olardan/onlardan

The second person plural pronoun can be used to denote formality or respect, even if its referent is a single person.

There are two roots, óz- , that express reflexivity. 

Possessive pronouns are formed by adding the suffix -kí to the genitive form of a personal pronoun, as in:

Possessive Pronouns
    Singular    Plural
1st Person  menímkí     bízímkí
2nd Person  seníñkí     sízíñkí
3rd Person  onîñkî      olarnîñkî / onlarnîñkî
...
O hepísínden dadlî baklawa píşíre.
...
export const POS_PREFIXES_FOR_CLEANING = [
  ...
  "I. ", "II. ", "III. ", "IV. ", "V. " // Roman numerals followed by dot and space
];
