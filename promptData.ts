...
- In some cases SCT K/Q becomes in DT G, Ex: SCT: keşir, çıqar, keşmek, Frenkistan -> DT: geşír, şîgar, geşmek, Frengístan
...
- garare - garajgatartuw
- înfuriat; mâniat; mânios - gazapkakelgen
- accesibil - geşílealgan
- astrologie - gezegenbílímí
- scuzabil - gúnasîndanboşatkanday
- înţelept; erudit; expert; cult - kóbokîgan
- bomboană - bombon
- bun; plăcut; agreabil - koş
- exagerare - múbalága
...
- telefon - uzakses
- calendar - kúnsayîm
- comicărie - kúldúrúwğúlúk
- dinamometru - kuwetólşer
...
- grup - takîm
- dragon - ajdaka
- anul dragonului (conform vechiului calendar tătăresc) - ajdaka senesí
...
- Crimean Tatar (RO): Yeşíl-Murun; Romanian: Republica Capului Verde
